...
struct SaveBlock2
{
    ...
    /*0x013*/ u8 optionsButtonMode;  // Saved button mode; legacy values are treated as LR.
    ...
    /*0x090*/ u8 appearanceVersion;
    /*0x091*/ u8 playerAccent;
    /*0x092*/ u8 playerSecondaryAccent;
