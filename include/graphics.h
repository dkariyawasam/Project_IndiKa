...
extern const u32 gMonFrontPic_Omato[];
extern const u32 gMonPalette_Omato[];
extern const u32 gMonBackPic_Omato[];
extern const u32 gMonShinyPalette_Omato[];
extern const u8 gMonIcon_Omato[];
extern const u8 gMonFootprint_Omato[];
extern const u32 gMonFrontPic_Omatops[];
extern const u32 gMonPalette_Omatops[];
extern const u32 gMonBackPic_Omatops[];
extern const u32 gMonShinyPalette_Omatops[];
extern const u8 gMonIcon_Omatops[];
extern const u8 gMonFootprint_Omatops[];
...
extern const u32 gMonFrontPic_CinnabarMagikarp[];
extern const u32 gMonPalette_CinnabarMagikarp[];
extern const u32 gMonBackPic_CinnabarMagikarp[];
extern const u32 gMonShinyPalette_CinnabarMagikarp[];
extern const u8 gMonIcon_CinnabarMagikarp[];
extern const u8 gMonFootprint_CinnabarMagikarp[];
...
extern const u32 gMonFrontPic_Osscythe[];
extern const u32 gMonPalette_Osscythe[];
extern const u32 gMonBackPic_Osscythe[];
extern const u32 gMonShinyPalette_Osscythe[];
...
extern const u32 gMonFrontPic_MimeSr[];
extern const u32 gMonBackPic_MimeSr[];
extern const u8 gMonIcon_MimeSr[];
...
// trainer sprites
extern const u32 gTrainerFrontPic_TrendsetterM[];
...
extern const u32 gTrainerFrontPic_GentlemanRS[];
...
extern const u32 gTrainerFrontPic_TriathleteMCycling[];
extern const u32 gTrainerFrontPic_TriathleteFCycling[];
extern const u32 gTrainerFrontPic_TriathleteMLand[];
extern const u32 gTrainerFrontPic_TriathleteFLand[];
extern const u32 gTrainerFrontPic_TriathleteMWater[];
extern const u32 gTrainerFrontPic_TriathleteFWater[];
extern const u32 gTrainerFrontPic_Ninja[];
extern const u32 gTrainerFrontPic_ParasolLady[];
extern const u32 gTrainerFrontPic_TwinsRS[];
extern const u32 gTrainerFrontPic_SailorRS[];
extern const u32 gTrainerFrontPic_PokemonBreederMRS[];
extern const u32 gTrainerFrontPic_PokemonBreederFRS[];
extern const u32 gTrainerFrontPic_YoungsterM[];
extern const u32 gTrainerFrontPic_BugCatcher[];
extern const u32 gTrainerFrontPic_YoungsterF[];
extern const u32 gTrainerFrontPic_Sailor[];
extern const u32 gTrainerFrontPic_ScoutM[];
extern const u32 gTrainerFrontPic_ScoutF[];
...
extern const u32 gTrainerFrontPic_TrendsetterF[];
...
extern const u32 gTrainerFrontPic_BlackBeltM[];
...
extern const u32 gTrainerFrontPic_Aces[];
...
extern const u32 gTrainerFrontPic_BlackBeltF[];
...
extern const u32 gTrainerPalette_GentlemanRS[];
...
extern const u32 gTrainerPalette_TriathleteMCycling[];
extern const u32 gTrainerPalette_TriathleteFCycling[];
extern const u32 gTrainerPalette_TriathleteMLand[];
extern const u32 gTrainerPalette_TriathleteFLand[];
extern const u32 gTrainerPalette_TriathleteMWater[];
extern const u32 gTrainerPalette_TriathleteFWater[];
extern const u32 gTrainerPalette_Ninja[];
extern const u32 gTrainerPalette_ParasolLady[];
extern const u32 gTrainerPalette_TwinsRS[];
extern const u32 gTrainerPalette_SailorRS[];
...
extern const u32 gTrainerPalette_PokemonBreederMRS[];
extern const u32 gTrainerPalette_PokemonBreederFRS[];
extern const u32 gTrainerPalette_YoungsterM[];
extern const u32 gTrainerPalette_BugCatcher[];
extern const u32 gTrainerPalette_YoungsterF[];
extern const u32 gTrainerPalette_Sailor[];
extern const u32 gTrainerPalette_ScoutM[];
extern const u32 gTrainerPalette_ScoutF[];
...
extern const u32 gTrainerPalette_TrendsetterF[];
...
extern const u32 gTrainerPalette_BlackBeltM[];
...
extern const u32 gTrainerPalette_Aces[];
...
extern const u32 gTrainerPalette_BlackBeltF[];
...
// help_menu
extern const u8 gHelpMenu_Gfx[];
extern const u8 gHelpMenuScreen_Tilemap[];
extern const u8 gHelpMenuTitle_Tilemap[];
extern const u32 gHelpMenu_Pal[];
...
extern const u32 gItemIcon_HasteFossil[];
...
extern const u32 gItemIcon_ApexLog[];
extern const u32 gItemIconPalette_ApexLog[];
...
extern const u8 gMonFootprint_MimeSr[];
extern const u8 gMonFootprint_Osscythe[];
extern const u8 gMonIcon_Osscythe[];
...
extern const u32 gMonFrontPic_RegionalPosePichu[];
extern const u32 gMonBackPic_RegionalPosePichu[];
extern const u32 gMonFrontPic_RegionalPosePikachu[];
extern const u32 gMonBackPic_RegionalPosePikachu[];
extern const u32 gMonFrontPic_RegionalPoseExeggcute[];
extern const u32 gMonBackPic_RegionalPoseExeggcute[];
extern const u32 gMonFrontPic_RegionalPoseCubone[];
extern const u32 gMonBackPic_RegionalPoseCubone[];
extern const u32 gMonFrontPic_RegionalPoseKoffing[];
extern const u32 gMonBackPic_RegionalPoseKoffing[];


extern const u32 gMonFrontPic_GalarianFarfetchd[];
extern const u32 gMonBackPic_GalarianFarfetchd[];
extern const u32 gMonPalette_GalarianFarfetchd[];
extern const u32 gMonShinyPalette_GalarianFarfetchd[];
extern const u8 gMonIcon_GalarianFarfetchd[];
extern const u32 gMonFrontPic_GalarianMeowth[];
extern const u32 gMonBackPic_GalarianMeowth[];
extern const u32 gMonPalette_GalarianMeowth[];
extern const u32 gMonShinyPalette_GalarianMeowth[];
extern const u8 gMonIcon_GalarianMeowth[];
extern const u32 gMonFrontPic_GalarianPerrserker[];
extern const u32 gMonBackPic_GalarianPerrserker[];
extern const u32 gMonPalette_GalarianPerrserker[];
extern const u32 gMonShinyPalette_GalarianPerrserker[];
extern const u8 gMonIcon_GalarianPerrserker[];
extern const u8 gMonFootprint_GalarianPerrserker[];
extern const u32 gMonFrontPic_GalarianCorsola[];
extern const u32 gMonBackPic_GalarianCorsola[];
extern const u32 gMonPalette_GalarianCorsola[];
extern const u32 gMonShinyPalette_GalarianCorsola[];
extern const u8 gMonIcon_GalarianCorsola[];
extern const u32 gMonFrontPic_GalarianCursola[];
extern const u32 gMonBackPic_GalarianCursola[];
extern const u32 gMonPalette_GalarianCursola[];
extern const u32 gMonShinyPalette_GalarianCursola[];
extern const u8 gMonIcon_GalarianCursola[];
extern const u8 gMonFootprint_GalarianCursola[];
extern const u32 gMonFrontPic_GalarianWeezing[];
extern const u32 gMonBackPic_GalarianWeezing[];
extern const u32 gMonPalette_GalarianWeezing[];
extern const u32 gMonShinyPalette_GalarianWeezing[];
extern const u8 gMonIcon_GalarianWeezing[];
