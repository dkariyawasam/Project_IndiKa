...
enum {
    ...
    // Reserve entries retained for older data that is no longer in the regional Dex.
...
#define KANTO_DEX_COUNT     NATIONAL_DEX_WEEZING_GALARIAN
#define JOHTO_DEX_COUNT     NATIONAL_DEX_WEEZING_GALARIAN
#define NATIONAL_DEX_COUNT  NATIONAL_DEX_WEEZING_GALARIAN
