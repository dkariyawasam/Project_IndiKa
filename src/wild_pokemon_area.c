...
static const u16 sDexAreas_Kanto[][2] = {
    ...
    { MAPSEC_VERMILION_HARBOR,    DEX_AREA_VERMILION_CITY },
    ...
    { MAPSEC_LEAGUE_INDIGO,       DEX_AREA_VICTORY_ROAD },
    { MAPSEC_LEAGUE_ROCKET,       DEX_AREA_CELADON_CITY },
    ...
    { MAPSEC_CELADON_CAVE,        DEX_AREA_CERULEAN_CAVE },
