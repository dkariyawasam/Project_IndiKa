...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(THERMIKARP),
    ...
    SPECIES_TO_NATIONAL(AMUNYTE),
    SPECIES_TO_NATIONAL(KINKABUTO),
    SPECIES_TO_NATIONAL(AEROPTERYX),
    ...
    SPECIES_TO_NATIONAL(PICHU_ALOLAN),
    SPECIES_TO_NATIONAL(PIKACHU_ALOLAN),
