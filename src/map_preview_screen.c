...
static const struct MapPreviewScreen sMapPreviewScreenData[MPS_COUNT] = {
    ...
    [MPS_CINNABAR_VOLCANO] = {
        .mapsec = MAPSEC_CINNABAR_VOLCANO,
        .type = MPS_TYPE_CAVE,
        .flagId = FLAG_WORLD_MAP_CINNABAR_VOLCANO,
        .tilesptr = sCinnabarVolcanoMapPreviewTiles,
        .tilemapptr = sCinnabarVolcanoMapPreviewTilemap,
        .palptr = sCinnabarVolcanoMapPreviewPalette
    },
    [MPS_FUCHSIA_FOREST] = {
