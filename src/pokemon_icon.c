...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_THERMIKARP] = gMonIcon_Thermikarp,
    ...
    [SPECIES_STARLY]      = gMonIcon_Pidgey,
    [SPECIES_STARAVIA]    = gMonIcon_Pidgeotto,
    [SPECIES_STARAPTOR]   = gMonIcon_Pidgeot,
    ...
    [SPECIES_INVISIBAS    ] = gMonIcon_QuestionMark,
