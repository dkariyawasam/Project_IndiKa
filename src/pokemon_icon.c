...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_OSSCYTHE     ] = gMonIcon_QuestionMark,
    ...
    [SPECIES_RATTATA_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_RATICATE_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_PICHU_ALOLAN ] = gMonIcon_QuestionMark,
    [SPECIES_PIKACHU_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_RAICHU_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_SANDSHREW_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_SANDSLASH_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_DIGLETT_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_DUGTRIO_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_MEOWTH_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_PERSIAN_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_MEOWTH_GALARIAN] = gMonIcon_QuestionMark,
    [SPECIES_PERRSERKER   ] = gMonIcon_QuestionMark,
    [SPECIES_GEODUDE_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_GRAVELER_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_GOLEM_ALOLAN ] = gMonIcon_QuestionMark,
    [SPECIES_GRIMER_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_MUK_ALOLAN   ] = gMonIcon_QuestionMark,
    [SPECIES_VULPIX_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_NINETALES_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_EXEGGCUTE_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_EXEGGUTOR_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_CUBONE_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_MAROWAK_ALOLAN] = gMonIcon_QuestionMark,
    [SPECIES_CORSOLA_GALARIAN] = gMonIcon_QuestionMark,
    [SPECIES_CURSOLA      ] = gMonIcon_QuestionMark,
    [SPECIES_KOFFING_GALARIAN] = gMonIcon_QuestionMark,
