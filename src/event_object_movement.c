...
#define OBJ_EVENT_PAL_TAG_OSSCYTHE                    0x1128
#define OBJ_EVENT_PAL_TAG_ANNIHILAPE                  0x1129
#define OBJ_EVENT_PAL_TAG_MIME_SR                     0x112A
#define OBJ_EVENT_PAL_TAG_RIVAL                       0x112B
#define OBJ_EVENT_PAL_TAG_TRENDSETTER_M                    0x112C
...
#define OBJ_EVENT_PAL_TAG_JANINE                     0x1141
#define OBJ_EVENT_PAL_TAG_MISTY                      0x1142
#define OBJ_EVENT_PAL_TAG_SCOUT                      0x1143
#define OBJ_EVENT_PAL_TAG_BLACK_BELT_F               0x1144
...
static const struct SpritePalette sObjectEventSpritePalettes[] = {
    ...
    {gObjectEventPal_TrendsetterM,                 OBJ_EVENT_PAL_TAG_TRENDSETTER_M},
    ...
    {gObjectEventPal_BlackBeltF,              OBJ_EVENT_PAL_TAG_BLACK_BELT_F},
...
u8 CreateApexLogObject(u8 graphicsId, u8 localId, s16 x, s16 y)
{
    u8 spriteId;
    struct Sprite *sprite;
    struct SpriteTemplate spriteTemplate;
