...
const u8 gText_PokedexTableOfContents[] = _("POKéDEX");
const u8 gText_PickOK[] = _("{DPAD_UPDOWN}PICK {B_BUTTON}CANCEL");
const u8 gText_Seen[] = _("Seen:");
const u8 gText_Owned[] = _("Owned:");
const u8 gText_Kanto[] = _("KANTO");
const u8 gText_National[] = _("NATIONAL");
const u8 gText_PokemonHabitats[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}HABITATS");
const u8 gText_DexCategory_GrasslandPkmn[] = _("Grassland");
const u8 gText_DexCategory_ForestPkmn[] = _("Forest");
const u8 gText_DexCategory_WatersEdgePkmn[] = _("Water's-edge");
...
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("Rough-terrain");
const u8 gText_DexCategory_UrbanPkmn[] = _("Urban");
const u8 gText_DexCategory_RarePkmn[] = _("Rare");
const u8 gText_DexCategory_NonNativePkmn[] = _("Non-native");
...
const u8 gText_NumericalModeNational[] = _("Numerical");
...
const u8 gApexLogText_Cancel[] = _("CANCEL");
...
const u8 gText_MenuSave[] = _("{L_BUTTON}SAVE");
const u8 gText_MenuSettings[] = _("SETTINGS");
const u8 gText_MenuOption[] = _("HELP");
...
const u8 gText_ItemfinderResponding[] = _("Huh?\nThe MARSH FINDER's responding!\pThere's an item buried around here!{PAUSE_UNTIL_PRESS}");
const u8 gText_ItemfinderShakingWildly[] = _("Oh!\nThe MARSH FINDER's shaking wildly!\pThere's an item buried underfoot!\p‥ ‥ ‥ ‥ ‥ ‥{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThrowInPremierBall[] = _("I'll throw in a PREMIER BALL\nas a bonus!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Tm01_4500Coins[] = _("TM01{CLEAR_TO 0x48}{FONT_SMALL}4,500 COINS");
const u8 gText_Tm02_5000Coins[] = _("TM02{CLEAR_TO 0x48}{FONT_SMALL}5,000 COINS");
const u8 gText_Tm03_3000Coins[] = _("TM03{CLEAR_TO 0x48}{FONT_SMALL}3,000 COINS");
const u8 gText_Tm04_3500Coins[] = _("TM04{CLEAR_TO 0x48}{FONT_SMALL}3,500 COINS");
const u8 gText_Tm05_1000Coins[] = _("TM05{CLEAR_TO 0x48}{FONT_SMALL}1,000 COINS");
const u8 gText_Tm06_4000Coins[] = _("TM06{CLEAR_TO 0x48}{FONT_SMALL}4,000 COINS");
const u8 gText_Tm07_1500Coins[] = _("TM07{CLEAR_TO 0x48}{FONT_SMALL}1,500 COINS");
const u8 gText_Tm08_3500Coins[] = _("TM08{CLEAR_TO 0x48}{FONT_SMALL}3,500 COINS");
const u8 gText_Tm09_1500Coins[] = _("TM09{CLEAR_TO 0x48}{FONT_SMALL}1,500 COINS");
const u8 gText_Tm10_3000Coins[] = _("TM10{CLEAR_TO 0x48}{FONT_SMALL}3,000 COINS");
const u8 gText_Tm11_2500Coins[] = _("TM11{CLEAR_TO 0x48}{FONT_SMALL}2,500 COINS");
const u8 gText_Tm12_2000Coins[] = _("TM12{CLEAR_TO 0x48}{FONT_SMALL}2,000 COINS");
const u8 gText_Tm13_5000Coins[] = _("TM13{CLEAR_TO 0x48}{FONT_SMALL}5,000 COINS");
const u8 gText_Tm14_6000Coins[] = _("TM14{CLEAR_TO 0x48}{FONT_SMALL}6,000 COINS");
const u8 gText_Tm15_6500Coins[] = _("TM15{CLEAR_TO 0x48}{FONT_SMALL}6,500 COINS");
const u8 gText_Tm16_2500Coins[] = _("TM16{CLEAR_TO 0x48}{FONT_SMALL}2,500 COINS");
const u8 gText_Tm17_4000Coins[] = _("TM17{CLEAR_TO 0x48}{FONT_SMALL}4,000 COINS");
const u8 gText_Tm18_2500Coins[] = _("TM18{CLEAR_TO 0x48}{FONT_SMALL}2,500 COINS");
const u8 gText_Tm19_3500Coins[] = _("TM19{CLEAR_TO 0x48}{FONT_SMALL}3,500 COINS");
const u8 gText_Tm20_2500Coins[] = _("TM20{CLEAR_TO 0x48}{FONT_SMALL}2,500 COINS");
const u8 gText_Tm21_1000Coins[] = _("TM21{CLEAR_TO 0x48}{FONT_SMALL}1,000 COINS");
const u8 gText_Tm22_4500Coins[] = _("TM22{CLEAR_TO 0x48}{FONT_SMALL}4,500 COINS");
const u8 gText_Tm23_3500Coins[] = _("TM23{CLEAR_TO 0x48}{FONT_SMALL}3,500 COINS");
const u8 gText_Tm24_5000Coins[] = _("TM24{CLEAR_TO 0x48}{FONT_SMALL}5,000 COINS");
const u8 gText_Tm25_6000Coins[] = _("TM25{CLEAR_TO 0x48}{FONT_SMALL}6,000 COINS");
const u8 gText_Tm26_6500Coins[] = _("TM26{CLEAR_TO 0x48}{FONT_SMALL}6,500 COINS");
const u8 gText_Tm27_3500Coins[] = _("TM27{CLEAR_TO 0x48}{FONT_SMALL}3,500 COINS");
const u8 gText_Tm28_3000Coins[] = _("TM28{CLEAR_TO 0x48}{FONT_SMALL}3,000 COINS");
const u8 gText_Tm29_5000Coins[] = _("TM29{CLEAR_TO 0x48}{FONT_SMALL}5,000 COINS");
const u8 gText_Tm30_4500Coins[] = _("TM30{CLEAR_TO 0x48}{FONT_SMALL}4,500 COINS");
const u8 gText_Tm31_4000Coins[] = _("TM31{CLEAR_TO 0x48}{FONT_SMALL}4,000 COINS");
const u8 gText_Tm32_1500Coins[] = _("TM32{CLEAR_TO 0x48}{FONT_SMALL}1,500 COINS");
const u8 gText_Tm33_2500Coins[] = _("TM33{CLEAR_TO 0x48}{FONT_SMALL}2,500 COINS");
const u8 gText_Tm34_3000Coins[] = _("TM34{CLEAR_TO 0x48}{FONT_SMALL}3,000 COINS");
const u8 gText_Tm35_5000Coins[] = _("TM35{CLEAR_TO 0x48}{FONT_SMALL}5,000 COINS");
const u8 gText_Tm36_4500Coins[] = _("TM36{CLEAR_TO 0x48}{FONT_SMALL}4,500 COINS");
const u8 gText_Tm37_2000Coins[] = _("TM37{CLEAR_TO 0x48}{FONT_SMALL}2,000 COINS");
const u8 gText_Tm38_6000Coins[] = _("TM38{CLEAR_TO 0x48}{FONT_SMALL}6,000 COINS");
const u8 gText_Tm39_2500Coins[] = _("TM39{CLEAR_TO 0x48}{FONT_SMALL}2,500 COINS");
const u8 gText_Tm40_3000Coins[] = _("TM40{CLEAR_TO 0x48}{FONT_SMALL}3,000 COINS");
const u8 gText_Tm41_1500Coins[] = _("TM41{CLEAR_TO 0x48}{FONT_SMALL}1,500 COINS");
const u8 gText_Tm42_3500Coins[] = _("TM42{CLEAR_TO 0x48}{FONT_SMALL}3,500 COINS");
const u8 gText_Tm43_2000Coins[] = _("TM43{CLEAR_TO 0x48}{FONT_SMALL}2,000 COINS");
const u8 gText_Tm44_2500Coins[] = _("TM44{CLEAR_TO 0x48}{FONT_SMALL}2,500 COINS");
const u8 gText_Tm45_1500Coins[] = _("TM45{CLEAR_TO 0x48}{FONT_SMALL}1,500 COINS");
const u8 gText_Tm46_2000Coins[] = _("TM46{CLEAR_TO 0x48}{FONT_SMALL}2,000 COINS");
const u8 gText_Tm47_3000Coins[] = _("TM47{CLEAR_TO 0x48}{FONT_SMALL}3,000 COINS");
const u8 gText_Tm48_2000Coins[] = _("TM48{CLEAR_TO 0x48}{FONT_SMALL}2,000 COINS");
const u8 gText_Tm49_1500Coins[] = _("TM49{CLEAR_TO 0x48}{FONT_SMALL}1,500 COINS");
const u8 gText_Tm50_6000Coins[] = _("TM50{CLEAR_TO 0x48}{FONT_SMALL}6,000 COINS");
const u8 gText_Tm51_1000Coins[] = _("TM51{CLEAR_TO 0x48}{FONT_SMALL}1,000 COINS");
const u8 gText_Tm52_4500Coins[] = _("TM52{CLEAR_TO 0x48}{FONT_SMALL}4,500 COINS");
const u8 gText_Tm53_5500Coins[] = _("TM53{CLEAR_TO 0x48}{FONT_SMALL}5,500 COINS");
const u8 gText_Tm54_3500Coins[] = _("TM54{CLEAR_TO 0x48}{FONT_SMALL}3,500 COINS");
const u8 gText_Tm55_1000Coins[] = _("TM55{CLEAR_TO 0x48}{FONT_SMALL}1,000 COINS");
...
const u8 gText_TMsAndHMs[] = _("TMs");
...
const u8 gText_Bicycle_Price[] = _("BICYCLE{CLEAR_TO 0x55}{FONT_SMALL}¥50,000");
...
const u8 gText_HelixHaste[] = _("HELIX + HASTE FOSSILS");
const u8 gText_HelixDart[] = _("HELIX + DART FOSSILS");
const u8 gText_DomeDart[] = _("DOME + DART FOSSILS");
const u8 gText_DomeHaste[] = _("DOME + HASTE FOSSILS");
...
const u8 gText_TmCase[] = _("TMs");
const u8 gText_BerryPouch_2[] = _("BERRIES");
...
const u8 gApexLogText_ApexLogWillBeClosed[] = _("The APEX LOG will be closed.");
const u8 gApexLogText_ClearTextbox[] = _("\n                              ");
...
const u8 gText_RegionMap_AreaDesc_CinnabarVolcano[] = _("Supposedly an inactive volcano.\nHowever, there are persistent\nreports that the peak blazes\nwith fire at night.");
const u8 gText_RegionMap_AreaDesc_FuchsiaForest[] = _("A dense woodland near FUCHSIA CITY\nwhere BERRIES grow wildly in\nprofusion, quickly replenishing\nthose that fall off.");
...
const u8 gText_PokeSum_PageName_PokemonInfo[] = _("INFO");
const u8 gText_PokeSum_PageName_PokemonSkills[] = _("STATS");
const u8 gText_PokeSum_PageName_KnownMoves[] = _("MOVESET");
...
const u8 gText_PokeSum_Controls_PageCancel[] = _("{DPAD_RIGHT}PAGE {B_BUTTON}BACK");
const u8 gText_PokeSum_Controls_Cancel[] = _("{B_BUTTON}BACK");
const u8 gText_PokeSum_Controls_Page[] = _("{DPAD_LEFTRIGHT}PAGE {B_BUTTON}BACK");
const u8 gText_PokeSum_Controls_PageDetail[] = _("{DPAD_LEFT}PAGE {A_BUTTON}DETAIL {B_BUTTON}BACK");
...
const u8 gText_ButtonMode[] = _("HELP");
...
const u8 gText_PickSwitchCancel[] = _("{DPAD_UPDOWN}PICK {DPAD_LEFTRIGHT}SWITCH {A_BUTTON}OK {B_BUTTON}CANCEL");
...
const u8 gJPText_NewTrainerHasCome[] = _("");
...
const u8 gApexLogText_MainScreenUI[] = _("{START_BUTTON}PICK {DPAD_UPDOWN}SELECT {A_BUTTON}OK");
const u8 gApexLogText_PickScreenUI[] = _("{START_BUTTON}PICK {DPAD_UPDOWN}SELECT {B_BUTTON}CANCEL");
const u8 gApexLogText_FlavorTextUI[] = _("{DPAD_ANY}PICK {A_BUTTON}READ {B_BUTTON}CANCEL");
const u8 gApexLogOakName[] = _("OAK");
const u8 gApexLogDaisyName[] = _("DAISY");
const u8 gApexLogBillName[] = _("BILL");
const u8 gApexLogMrFujiName[] = _("FUJI");
...
const u8 gText_SideQuestName_4[] = _("GIOVANNI'S AMBITION");
const u8 gText_SideQuestName_5[] = _("ROCKET LEAGUE");
const u8 gText_SideQuestName_6[] = _("INDIGO LEAGUE");
...
const u8 gText_SideQuestDesc_4[] = _("Follow GIOVANNI's pursuit of\nabsolute power through MEWTWO.");
const u8 gText_SideQuestDesc_5[] = _("Challenge TEAM ROCKET's league\nand test their ambition.");
const u8 gText_SideQuestDesc_6[] = _("Challenge KANTO's strongest\ntrainers at the INDIGO LEAGUE.");
...
const u8 gText_SideQuestDoneDesc_4[] = _("GIOVANNI abandoned absolute power\nand disbanded TEAM ROCKET.");
const u8 gText_SideQuestDoneDesc_5[] = _("You conquered TEAM ROCKET's\nleague challenge.");
const u8 gText_SideQuestDoneDesc_6[] = _("You proved yourself at the\nINDIGO LEAGUE.");
...
const u8 gText_SideQuestMap4[] = _("KANTO");
const u8 gText_SideQuestMap5[] = _("KANTO");
const u8 gText_SideQuestMap6[] = _("KANTO");
...
const u8 gText_SubQuest4_Name1[] = _("POKéMON MANSION");
const u8 gText_SubQuest4_Name2[] = _("SILPH SIGNAL");
const u8 gText_SubQuest4_Name3[] = _("CERULEAN CAVE");
const u8 gText_SubQuest4_Name4[] = _("VIRIDIAN GYM");
...
const u8 gText_SubQuest4_Map1[] = _("POKéMON MANSION");
const u8 gText_SubQuest4_Map2[] = _("SILPH CO.");
const u8 gText_SubQuest4_Map3[] = _("CERULEAN CAVE");
const u8 gText_SubQuest4_Map4[] = _("VIRIDIAN GYM");
...
const u8 gText_SubQuest4_Desc3[] = _("GIOVANNI reached MEWTWO in\nCERULEAN CAVE.");
const u8 gText_SubQuest4_Desc4[] = _("Defeat GIOVANNI in VIRIDIAN GYM\nand end his pursuit of power.");
