...
const u8 gText_SubQuest4_Name3[] = _("ROUTE 7 RAMPAGE");
const u8 gText_SubQuest4_Name4[] = _("CERULEAN CAVE");
const u8 gText_SubQuest4_Name5[] = _("VIRIDIAN GYM");
...
const u8 gText_SubQuest4_Map3[] = _("ROUTE 7");
const u8 gText_SubQuest4_Map4[] = _("CERULEAN CAVE");
