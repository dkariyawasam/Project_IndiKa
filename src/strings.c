...
//names
const u8 gText_SideQuestName_1[] = _("The Nature of Evolution");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Study Pokémon evolution across the\nKANTO region.");
...
//map
const u8 gText_SideQuestMap1[] = _("KANTO");
