...
const u8 gText_HelixHaste[] = _("HELIX + HASTE SHARDS");
const u8 gText_HelixDart[] = _("HELIX + DART SHARDS");
const u8 gText_DomeDart[] = _("DOME + DART SHARDS");
const u8 gText_DomeHaste[] = _("DOME + HASTE SHARDS");
