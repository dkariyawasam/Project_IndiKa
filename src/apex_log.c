...
static const u8 sApexLoc_SilphCo[] = _("SILPH CO.");
static const u8 sApexLoc_CeladonCave[] = _("CELADON CAVE");
...
static const u8 sApexRumor_Annihilape0[] = _("Something angry and primal\nwaits deep in MT. MOON.");
static const u8 sApexRumor_Annihilape1[] = _("An enormous POKEMON smashed\nthrough a wall and went west.");
static const u8 sApexRumor_Annihilape2[] = _("A hulking PRIMEAPE hid inside\nMT. MOON, out of control!");
...
static const struct ApexRumorDossierEntry sApexRumorDossierEntries[QUEST_3_SUB_COUNT] =
{
    [SUB_QUEST_APEX_TANGROWTH] =
    {
        ...
        {OBJ_EVENT_GFX_CIV_WOMAN_3, OBJ_EVENT_GFX_CIV_WOMAN_2, OBJ_EVENT_GFX_AROMA_LADY},
    ...
    [SUB_QUEST_APEX_MEWTWO] =
    {
        ...
        {sApexLoc_PokemonMansion, sApexLoc_SilphCo, sApexLoc_CeladonCave},
        {sApexSrc_Giovanni, sApexSrc_SilphPresident, sApexSrc_Lance},
        {OBJ_EVENT_GFX_GIOVANNI, OBJ_EVENT_GFX_CIV_OLD_MAN_2, OBJ_EVENT_GFX_LANCE},
...
static const u8 sApexLogTrainerPicIdxs[] = {
    ...
    [APEX_LOG_PERSON_DAISY]    = TRAINER_PIC_YOUNGSTER_F,
...
static const u8 sApexLogArrayNpcGraphicsIds[] = {
    ...
    OBJ_EVENT_GFX_CLIPBOARD,
    OBJ_EVENT_GFX_CIV_OLD_WOMAN,
    OBJ_EVENT_GFX_CLIPBOARD,
    // BROCK
    OBJ_EVENT_GFX_GYM_SIGN,
    OBJ_EVENT_GFX_BROCK,
    OBJ_EVENT_GFX_CIV_MAN_2,
    OBJ_EVENT_GFX_CIV_BOY,
    ...
    OBJ_EVENT_GFX_SCIENTIST,
    OBJ_EVENT_GFX_CIV_WOMAN_2,
    OBJ_EVENT_GFX_CLIPBOARD,
    OBJ_EVENT_GFX_CLIPBOARD,
    // LORELEI
    OBJ_EVENT_GFX_LORELEI,
    OBJ_EVENT_GFX_LORELEI,
    OBJ_EVENT_GFX_CIV_OLD_MAN_1,
    OBJ_EVENT_GFX_CLIPBOARD,
    OBJ_EVENT_GFX_CIV_LITTLE_GIRL,
    OBJ_EVENT_GFX_CIV_OLD_WOMAN,
    // BRUNO
    OBJ_EVENT_GFX_BRUNO,
    OBJ_EVENT_GFX_BRUNO,
    ...
    OBJ_EVENT_GFX_CIV_WOMAN_1,
    OBJ_EVENT_GFX_CLIPBOARD,
    OBJ_EVENT_GFX_ACE_TRAINER_M,
    // BILL
    OBJ_EVENT_GFX_BLUE,
    OBJ_EVENT_GFX_YOUNGSTER_M,
    OBJ_EVENT_GFX_CIV_OLD_MAN_1,
    OBJ_EVENT_GFX_SCIENTIST,
    OBJ_EVENT_GFX_GENTLEMAN,
    OBJ_EVENT_GFX_CIV_MAN,
