...
static const u8 sText_SilphScopeUnveil[] = _("The GHOST's identity was\nrevealed!");
...
const u8 gText_ForPetesSake[] = _("");
const u8 gText_TheTrainerThat[] = _("");
const u8 gText_TryBattling[] = _("");
