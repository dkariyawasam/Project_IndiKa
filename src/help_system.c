...
static const u8 sDungeonMaps[][3] = {
    ...
    { MAP_GROUP(MAP_CINNABAR_VOLCANO_RUBY_PATH_B4F), MAP_NUM(MAP_CINNABAR_VOLCANO_RUBY_PATH_B4F), 1 },
    { MAP_GROUP(MAP_CINNABAR_VOLCANO_SUMMIT_PATH_1F), MAP_NUM(MAP_CINNABAR_VOLCANO_SUMMIT_PATH_1F), 3 },
    { MAP_GROUP(MAP_CINNABAR_VOLCANO_RUBY_PATH_B5F), MAP_NUM(MAP_CINNABAR_VOLCANO_RUBY_PATH_B5F), 7 },
    { MAP_GROUP(MAP_FUCHSIA_FOREST), MAP_NUM(MAP_FUCHSIA_FOREST), 1 },
    ...
    { MAP_GROUP(MAP_ROCK_TUNNEL_B2F), MAP_NUM(MAP_ROCK_TUNNEL_B2F), 1 }
};
