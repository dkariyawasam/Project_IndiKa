...
static const u8 sDungeonMaps[][3] = {
    ...
    { MAP_GROUP(MAP_CINNABAR_VOLCANO_1F), MAP_NUM(MAP_CINNABAR_VOLCANO_1F), 1 },
    { MAP_GROUP(MAP_CINNABAR_VOLCANO_LEFT_CORRIDOR_1F), MAP_NUM(MAP_CINNABAR_VOLCANO_LEFT_CORRIDOR_1F), 3 },
    { MAP_GROUP(MAP_CINNABAR_VOLCANO_3F), MAP_NUM(MAP_CINNABAR_VOLCANO_3F), 7 },
