...
const u8 gHelpMenu_Border_Gfx[] = INCBIN_U8("graphics/help_menu/border.4bpp.lz"); // Unused
const u8 gHelpMenu_Gfx[] = INCBIN_U8("graphics/help_menu/tiles.4bpp.lz");
const u8 gHelpMenuScreen_Tilemap[] = INCBIN_U8("graphics/help_menu/screen.bin.lz");
const u8 gHelpMenuTitle_Tilemap[] = INCBIN_U8("graphics/help_menu/title.bin.lz");
const u32 gHelpMenu_Pal[] = INCBIN_U32("graphics/help_menu/tiles.gbapal.lz");
