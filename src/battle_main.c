...
const struct TrainerMoney gTrainerMoneyTable[] =
{
    ...
    {TRAINER_CLASS_SCOUT, 1},
    {TRAINER_CLASS_PSYCHIC, 3},
    ...
    {TRAINER_CLASS_AROMA_LADY, 3},
    {TRAINER_CLASS_RUIN_MANIAC, 3},
    {TRAINER_CLASS_LADY, 50},
    {TRAINER_CLASS_ROCKET_ADMIN, 12},
    {TRAINER_CLASS_ROCKET_ACE, 10},
    {TRAINER_CLASS_TWINS, 3},
    {TRAINER_CLASS_TRENDSETTERS, 7},
    {TRAINER_CLASS_SIS_AND_BRO, 1},
    {TRAINER_CLASS_ACES, 6},
    {TRAINER_CLASS_CRUSH_KIN, 6},
    {TRAINER_CLASS_PLAYER, 1},
    {TRAINER_CLASS_TRIATHLETE, 10},
    {TRAINER_CLASS_TRENDSETTER_M, 50},
...
static u8 CreateNPCTrainerParty(struct Pokemon *party, u16 trainerNum)
{
    ...
    if (gBattleTypeFlags & BATTLE_TYPE_TRAINER
     && !(gBattleTypeFlags & (BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_EREADER_TRAINER)))
    {
        ZeroEnemyPartyMons();
...
static void HandleEndTurn_FinishBattle(void)
{
    ...
    {
        if (!(gBattleTypeFlags & (BATTLE_TYPE_EREADER_TRAINER | BATTLE_TYPE_OLD_MAN_TUTORIAL | BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_SAFARI | BATTLE_TYPE_FIRST_BATTLE | BATTLE_TYPE_LINK)))
        {
            for (gActiveBattler = 0; gActiveBattler < gBattlersCount; gActiveBattler++)
            {
                if (GetBattlerSide(gActiveBattler) == B_SIDE_PLAYER)
