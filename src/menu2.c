...
static const u8 sMonPosAttributes[][PSA_MON_ATTR_COUNT] = {
    ...
    [SPECIES_STARLY          - 1] = {26, 16, 48, 23, 31},
    [SPECIES_STARAVIA        - 1] = {24, 18, 48, 24, 31},
    [SPECIES_STARAPTOR       - 1] = {20, 18, 48, 20, 31},
    ...
    [SPECIES_CINNABAR_MAGIKARP     - 1] = {27, 23, 48, 27, 36},
    ...
    [SPECIES_GALLADE         - 1] = {38,  9, 40, 37, 23},
