const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_MEW] = _("MEW"),
    [SPECIES_THERMIKARP] = _("THERMIKARP"),
    ...
    [SPECIES_MIME_SR] = _("MIME SR."),
    [SPECIES_MISMAGIUS] = _("MISMAGIUS"),
    [SPECIES_SPIRITOMB] = _("SPIRITOMB"),
    [SPECIES_DUSKNOIR] = _("DUSKNOIR"),
    [SPECIES_OSSCYTHE] = _("OSSCYTHE"),
    [SPECIES_RHYPERIOR] = _("RHYPERIOR"),
    [SPECIES_INVISIBAS] = _("INVISIBAS"),
    [SPECIES_WEAVILE] = _("WEAVILE"),
    [SPECIES_MAMOSWINE] = _("MAMOSWINE"),
    [SPECIES_FROSLASS] = _("FROSLASS"),
    [SPECIES_MAGMORTAR] = _("MAGMORTAR"),
    [SPECIES_KABUSTAR] = _("KABUSTAR"),
    [SPECIES_KABUKNIGHT] = _("KABUKNIGHT"),
    [SPECIES_AMUNYTE] = _("AMUNYTE"),
    [SPECIES_KINKABUTO] = _("KINKABUTO"),
    [SPECIES_AEROPTERYX] = _("AEROPTERYX"),
    [SPECIES_PORYGON_Z] = _("PORYGON-Z"),
    [SPECIES_LEAFEON] = _("LEAFEON"),
    [SPECIES_GLACEON] = _("GLACEON"),
    [SPECIES_SYLVEON] = _("SYLVEON"),
    [SPECIES_FARFETCHD_GALARIAN] = _("G-FARFETCH"),
    [SPECIES_TYNAMO] = _("TYNAMO"),
    [SPECIES_EELEKTRIK] = _("EELEKTRIK"),
    [SPECIES_EELEKTROSS] = _("EELEKTROSS"),
    [SPECIES_RATTATA_ALOLAN] = _("A-RATTATA"),
    [SPECIES_RATICATE_ALOLAN] = _("A-RATICATE"),
    [SPECIES_PICHU_ALOLAN] = _("A-PICHU"),
    [SPECIES_PIKACHU_ALOLAN] = _("A-PIKACHU"),
    [SPECIES_RAICHU_ALOLAN] = _("A-RAICHU"),
    [SPECIES_SANDSHREW_ALOLAN] = _("A-SANDSHW"),
    [SPECIES_SANDSLASH_ALOLAN] = _("A-SANDSL"),
    [SPECIES_DIGLETT_ALOLAN] = _("A-DIGLETT"),
    [SPECIES_DUGTRIO_ALOLAN] = _("A-DUGTRIO"),
    [SPECIES_MEOWTH_ALOLAN] = _("A-MEOWTH"),
    [SPECIES_PERSIAN_ALOLAN] = _("A-PERSIAN"),
    [SPECIES_MEOWTH_GALARIAN] = _("G-MEOWTH"),
    [SPECIES_PERRSERKER] = _("PERRSERKER"),
    [SPECIES_GEODUDE_ALOLAN] = _("A-GEODUDE"),
    [SPECIES_GRAVELER_ALOLAN] = _("A-GRAVELR"),
    [SPECIES_GOLEM_ALOLAN] = _("A-GOLEM"),
    [SPECIES_GRIMER_ALOLAN] = _("A-GRIMER"),
    [SPECIES_MUK_ALOLAN] = _("A-MUK"),
    [SPECIES_VULPIX_ALOLAN] = _("A-VULPIX"),
    [SPECIES_NINETALES_ALOLAN] = _("A-NINETS"),
    [SPECIES_EXEGGCUTE_ALOLAN] = _("A-EXEGGC"),
    [SPECIES_EXEGGUTOR_ALOLAN] = _("A-EXEGGR"),
    [SPECIES_CUBONE_ALOLAN] = _("A-CUBONE"),
    [SPECIES_MAROWAK_ALOLAN] = _("A-MAROWAK"),
    [SPECIES_CORSOLA_GALARIAN] = _("G-CORSOLA"),
    [SPECIES_CURSOLA] = _("CURSOLA"),
    [SPECIES_KOFFING_GALARIAN] = _("G-KOFFING"),
    [SPECIES_WEEZING_GALARIAN] = _("G-WEEZING"),
