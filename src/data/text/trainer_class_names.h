const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_RS_CAMPER]           = _("{PKMN} TRAINER"),
    ...
    [TRAINER_CLASS_RS_PICNICKER]        = _("{PKMN} TRAINER"),
    ...
    [TRAINER_CLASS_CAMPER]              = _("SCOUT"),
    [TRAINER_CLASS_PICNICKER]           = _("SCOUT"),
    ...
    [TRAINER_CLASS_ROCKER]              = _("ELECTRICIAN"),
    ...
    [TRAINER_CLASS_CRUSH_GIRL]          = _("BATTLE GIRL"),
