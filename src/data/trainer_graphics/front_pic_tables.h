...
{
    TRAINER_SPRITE(AROMA_LADY_RS, gTrainerFrontPic_AromaLadyRS, 0x800),
    TRAINER_SPRITE(RUIN_MANIAC_RS, gTrainerFrontPic_RuinManiacRS, 0x800),
    TRAINER_SPRITE(TUBER_F_RS, gTrainerFrontPic_TuberFRS, 0x800),
    TRAINER_SPRITE(TUBER_M_RS, gTrainerFrontPic_TuberMRS, 0x800),
    TRAINER_SPRITE(HEX_MANIAC, gTrainerFrontPic_HexManiac, 0x800),
    TRAINER_SPRITE(LADY_RS, gTrainerFrontPic_LadyRS, 0x800),
    TRAINER_SPRITE(BEAUTY_RS, gTrainerFrontPic_BeautyRS, 0x800),
    TRAINER_SPRITE(RICH_BOY, gTrainerFrontPic_RichBoy, 0x800),
    TRAINER_SPRITE(POKEMANIAC_RS, gTrainerFrontPic_PokeManiacRS, 0x800),
    TRAINER_SPRITE(SWIMMER_M_RS, gTrainerFrontPic_SwimmerMRS, 0x800),
    TRAINER_SPRITE(BLACK_BELT_M_RS, gTrainerFrontPic_BlackBeltMRS, 0x800),
    TRAINER_SPRITE(GUITARIST, gTrainerFrontPic_Guitarist, 0x800),
    TRAINER_SPRITE(KINDLER, gTrainerFrontPic_Kindler, 0x800),
    TRAINER_SPRITE(SCOUT_M_RS, gTrainerFrontPic_ScoutMRS, 0x800),
    TRAINER_SPRITE(BUG_MANIAC, gTrainerFrontPic_BugManiac, 0x800),
    TRAINER_SPRITE(PSYCHIC_M_RS, gTrainerFrontPic_PsychicMRS, 0x800),
    TRAINER_SPRITE(PSYCHIC_F_RS, gTrainerFrontPic_PsychicFRS, 0x800),
    ...
    TRAINER_SPRITE(YOUNGSTER_RS, gTrainerFrontPic_YoungsterRS, 0x800),
    TRAINER_SPRITE(FISHERMAN_RS, gTrainerFrontPic_FishermanRS, 0x800),
    ...
    TRAINER_SPRITE(BIRD_KEEPER_RS, gTrainerFrontPic_BirdKeeperRS, 0x800),
    TRAINER_SPRITE(NINJA_BOY, gTrainerFrontPic_NinjaBoy, 0x800),
    TRAINER_SPRITE(BLACK_BELT_F_RS, gTrainerFrontPic_BlackBeltFRS, 0x1000),
    TRAINER_SPRITE(PARASOL_LADY, gTrainerFrontPic_ParasolLady, 0x800),
    TRAINER_SPRITE(SWIMMER_F_RS, gTrainerFrontPic_SwimmerFRS, 0x800),
    TRAINER_SPRITE(SCOUT_F_RS, gTrainerFrontPic_ScoutFRS, 0x800),
    ...
    TRAINER_SPRITE(POKEMON_RANGER_M_RS, gTrainerFrontPic_PokemonRangerMRS, 0x800),
    TRAINER_SPRITE(POKEMON_RANGER_F_RS, gTrainerFrontPic_PokemonRangerFRS, 0x800),
    TRAINER_SPRITE(LASS_RS, gTrainerFrontPic_LassRS, 0x800),
    TRAINER_SPRITE(BUG_CATCHER_RS, gTrainerFrontPic_BugCatcherRS, 0x800),
    TRAINER_SPRITE(HIKER_RS, gTrainerFrontPic_HikerRS, 0x800),
    ...
    TRAINER_SPRITE(SIS_AND_BRO_RS, gTrainerFrontPic_SisAndBroRS, 0x800),
...
{
    TRAINER_PAL(AROMA_LADY_RS, gTrainerPalette_AromaLadyRS),
    TRAINER_PAL(RUIN_MANIAC_RS, gTrainerPalette_RuinManiacRS),
    TRAINER_PAL(TUBER_F_RS, gTrainerPalette_TuberFRS),
    TRAINER_PAL(TUBER_M_RS, gTrainerPalette_TuberMRS),
    TRAINER_PAL(HEX_MANIAC, gTrainerPalette_HexManiac),
    TRAINER_PAL(LADY_RS, gTrainerPalette_LadyRS),
    TRAINER_PAL(BEAUTY_RS, gTrainerPalette_BeautyRS),
    TRAINER_PAL(RICH_BOY, gTrainerPalette_RichBoy),
    TRAINER_PAL(POKEMANIAC_RS, gTrainerPalette_PokeManiacRS),
    TRAINER_PAL(SWIMMER_M_RS, gTrainerPalette_SwimmerMRS),
    TRAINER_PAL(BLACK_BELT_M_RS, gTrainerPalette_BlackBeltMRS),
    TRAINER_PAL(GUITARIST, gTrainerPalette_Guitarist),
    TRAINER_PAL(KINDLER, gTrainerPalette_Kindler),
    TRAINER_PAL(SCOUT_M_RS, gTrainerPalette_ScoutMRS),
    TRAINER_PAL(BUG_MANIAC, gTrainerPalette_BugManiac),
    TRAINER_PAL(PSYCHIC_M_RS, gTrainerPalette_PsychicMRS),
    TRAINER_PAL(PSYCHIC_F_RS, gTrainerPalette_PsychicFRS),
    ...
    TRAINER_PAL(YOUNGSTER_RS, gTrainerPalette_YoungsterRS),
    TRAINER_PAL(FISHERMAN_RS, gTrainerPalette_FishermanRS),
    ...
    TRAINER_PAL(BIRD_KEEPER_RS, gTrainerPalette_BirdKeeperRS),
    TRAINER_PAL(NINJA_BOY, gTrainerPalette_NinjaBoy),
    TRAINER_PAL(BLACK_BELT_F_RS, gTrainerPalette_BlackBeltFRS),
    TRAINER_PAL(PARASOL_LADY, gTrainerPalette_ParasolLady),
    TRAINER_PAL(SWIMMER_F_RS, gTrainerPalette_SwimmerFRS),
    TRAINER_PAL(SCOUT_F_RS, gTrainerPalette_ScoutFRS),
    ...
    TRAINER_PAL(POKEMON_RANGER_M_RS, gTrainerPalette_PokemonRangerMRS),
    TRAINER_PAL(POKEMON_RANGER_F_RS, gTrainerPalette_PokemonRangerFRS),
    TRAINER_PAL(LASS_RS, gTrainerPalette_LassRS),
    TRAINER_PAL(BUG_CATCHER_RS, gTrainerPalette_BugCatcherRS),
    TRAINER_PAL(HIKER_RS, gTrainerPalette_HikerRS),
    TRAINER_PAL(YOUNG_COUPLE_RS, gTrainerPalette_YoungCoupleRS),
    TRAINER_PAL(OLD_COUPLE, gTrainerPalette_OldCouple),
    TRAINER_PAL(SIS_AND_BRO_RS, gTrainerPalette_SisAndBroRS),
