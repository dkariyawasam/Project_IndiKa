const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(CINNABAR_MAGIKARP, gMonFrontPic_CinnabarMagikarp),
    ...
    SPECIES_SPRITE(TREECKO, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(GROVYLE, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(SCEPTILE, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(TORCHIC, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(COMBUSKEN, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(BLAZIKEN, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(MUDKIP, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(MARSHTOMP, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(SWAMPERT, gMonFrontPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(LOTAD, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(LOMBRE, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(LUDICOLO, gMonFrontPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(SURSKIT, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(MASQUERAIN, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(WAILMER, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(WAILORD, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(SKITTY, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(DELCATTY, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(KECLEON, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(BALTOY, gMonFrontPic_Baltoy),
    SPECIES_SPRITE(CLAYDOL, gMonFrontPic_Claydol),
    SPECIES_SPRITE(NOSEPASS, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(TORKOAL, gMonFrontPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(CORPHISH, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(CRAWDAUNT, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(FEEBAS, gMonFrontPic_Feebas),
    SPECIES_SPRITE(MILOTIC, gMonFrontPic_Milotic),
    SPECIES_SPRITE(CARVANHA, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(SHARPEDO, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(TRAPINCH, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(VIBRAVA, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(FLYGON, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(MAKUHITA, gMonFrontPic_Makuhita),
    SPECIES_SPRITE(HARIYAMA, gMonFrontPic_Hariyama),
    SPECIES_SPRITE(ELECTRIKE, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(MANECTRIC, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(NUMEL, gMonFrontPic_Numel),
    SPECIES_SPRITE(CAMERUPT, gMonFrontPic_Camerupt),
    SPECIES_SPRITE(SPHEAL, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(SEALEO, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(WALREIN, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(CACNEA, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(CACTURNE, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(SNORUNT, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(GLALIE, gMonFrontPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(TROPIUS, gMonFrontPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(SHUPPET, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(BANETTE, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(SEVIPER, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(ZANGOOSE, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(RELICANTH, gMonFrontPic_Relicanth),
    SPECIES_SPRITE(ARON, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(LAIRON, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(AGGRON, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(CASTFORM, gMonFrontPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(BAGON, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(SHELGON, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(SALAMENCE, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(BELDUM, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(METANG, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(METAGROSS, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(REGIROCK, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(REGICE, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(REGISTEEL, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(KYOGRE, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(GROUDON, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(RAYQUAZA, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(LATIAS, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(LATIOS, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(JIRACHI, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(DEOXYS, gMonFrontPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(OMATO, gMonFrontPic_Omato),
    SPECIES_SPRITE(OMATOPS, gMonFrontPic_Omatops),
    ...
    SPECIES_SPRITE(MIME_SR, gMonFrontPic_MimeSr),
    SPECIES_SPRITE(MISMAGIUS, gMonFrontPic_Mismagius),
    SPECIES_SPRITE(SPIRITOMB, gMonFrontPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(KABUSTAR, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(KABUKNIGHT, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(AMUNYTE, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(KINKABUTO, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(AEROPTERYX, gMonFrontPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(FARFETCHD_GALARIAN, gMonFrontPic_GalarianFarfetchd),
    ...
    SPECIES_SPRITE(RATTATA_ALOLAN, gMonFrontPic_AlolanRattata),
    SPECIES_SPRITE(RATICATE_ALOLAN, gMonFrontPic_AlolanRaticate),
    SPECIES_SPRITE(PICHU_ALOLAN, gMonFrontPic_RegionalPosePichu),
    SPECIES_SPRITE(PIKACHU_ALOLAN, gMonFrontPic_RegionalPosePikachu),
    SPECIES_SPRITE(RAICHU_ALOLAN, gMonFrontPic_AlolanRaichu),
    SPECIES_SPRITE(SANDSHREW_ALOLAN, gMonFrontPic_AlolanSandshrew),
    SPECIES_SPRITE(SANDSLASH_ALOLAN, gMonFrontPic_AlolanSandslash),
    SPECIES_SPRITE(DIGLETT_ALOLAN, gMonFrontPic_AlolanDiglett),
    SPECIES_SPRITE(DUGTRIO_ALOLAN, gMonFrontPic_AlolanDugtrio),
    SPECIES_SPRITE(MEOWTH_ALOLAN, gMonFrontPic_AlolanMeowth),
    SPECIES_SPRITE(PERSIAN_ALOLAN, gMonFrontPic_AlolanPersian),
    SPECIES_SPRITE(MEOWTH_GALARIAN, gMonFrontPic_GalarianMeowth),
    SPECIES_SPRITE(PERRSERKER, gMonFrontPic_GalarianPerrserker),
    SPECIES_SPRITE(GEODUDE_ALOLAN, gMonFrontPic_AlolanGeodude),
    SPECIES_SPRITE(GRAVELER_ALOLAN, gMonFrontPic_AlolanGraveler),
    SPECIES_SPRITE(GOLEM_ALOLAN, gMonFrontPic_AlolanGolem),
    SPECIES_SPRITE(GRIMER_ALOLAN, gMonFrontPic_AlolanGrimer),
    SPECIES_SPRITE(MUK_ALOLAN, gMonFrontPic_AlolanMuk),
    SPECIES_SPRITE(VULPIX_ALOLAN, gMonFrontPic_AlolanVulpix),
    SPECIES_SPRITE(NINETALES_ALOLAN, gMonFrontPic_AlolanNinetales),
    SPECIES_SPRITE(EXEGGCUTE_ALOLAN, gMonFrontPic_RegionalPoseExeggcute),
    SPECIES_SPRITE(EXEGGUTOR_ALOLAN, gMonFrontPic_AlolanExeggutor),
    SPECIES_SPRITE(CUBONE_ALOLAN, gMonFrontPic_RegionalPoseCubone),
    SPECIES_SPRITE(MAROWAK_ALOLAN, gMonFrontPic_AlolanMarowak),
    SPECIES_SPRITE(CORSOLA_GALARIAN, gMonFrontPic_GalarianCorsola),
    SPECIES_SPRITE(CURSOLA, gMonFrontPic_GalarianCursola),
    SPECIES_SPRITE(KOFFING_GALARIAN, gMonFrontPic_RegionalPoseKoffing),
    SPECIES_SPRITE(WEEZING_GALARIAN, gMonFrontPic_GalarianWeezing),
