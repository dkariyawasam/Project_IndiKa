const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(CINNABAR_MAGIKARP, gMonBackPic_CinnabarMagikarp),
    ...
    SPECIES_SPRITE(TREECKO, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(GROVYLE, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(SCEPTILE, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(TORCHIC, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(COMBUSKEN, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(BLAZIKEN, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(MUDKIP, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(MARSHTOMP, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(SWAMPERT, gMonBackPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(LOTAD, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(LOMBRE, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(LUDICOLO, gMonBackPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(SURSKIT, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(MASQUERAIN, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(WAILMER, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(WAILORD, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(SKITTY, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(DELCATTY, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(KECLEON, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(BALTOY, gMonBackPic_Baltoy),
    SPECIES_SPRITE(CLAYDOL, gMonBackPic_Claydol),
    SPECIES_SPRITE(NOSEPASS, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(TORKOAL, gMonBackPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(CORPHISH, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(CRAWDAUNT, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(FEEBAS, gMonBackPic_Feebas),
    SPECIES_SPRITE(MILOTIC, gMonBackPic_Milotic),
    SPECIES_SPRITE(CARVANHA, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(SHARPEDO, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(TRAPINCH, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(VIBRAVA, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(FLYGON, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(MAKUHITA, gMonBackPic_Makuhita),
    SPECIES_SPRITE(HARIYAMA, gMonBackPic_Hariyama),
    SPECIES_SPRITE(ELECTRIKE, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(MANECTRIC, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(NUMEL, gMonBackPic_Numel),
    SPECIES_SPRITE(CAMERUPT, gMonBackPic_Camerupt),
    SPECIES_SPRITE(SPHEAL, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(SEALEO, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(WALREIN, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(CACNEA, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(CACTURNE, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(SNORUNT, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(GLALIE, gMonBackPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(TROPIUS, gMonBackPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(SHUPPET, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(BANETTE, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(SEVIPER, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(ZANGOOSE, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(RELICANTH, gMonBackPic_Relicanth),
    SPECIES_SPRITE(ARON, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(LAIRON, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(AGGRON, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(CASTFORM, gMonBackPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(BAGON, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(SHELGON, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(SALAMENCE, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(BELDUM, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(METANG, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(METAGROSS, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(REGIROCK, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(REGICE, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(REGISTEEL, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(KYOGRE, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(GROUDON, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(RAYQUAZA, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(LATIAS, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(LATIOS, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(JIRACHI, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(DEOXYS, gMonBackPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(OMATO, gMonBackPic_Omato),
    SPECIES_SPRITE(OMATOPS, gMonBackPic_Omatops),
    ...
    SPECIES_SPRITE(MIME_SR, gMonBackPic_MimeSr),
    SPECIES_SPRITE(MISMAGIUS, gMonBackPic_Mismagius),
    SPECIES_SPRITE(SPIRITOMB, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(DUSKNOIR, gMonBackPic_Dusknoir),
    SPECIES_SPRITE(OSSCYTHE, gMonBackPic_Osscythe),
    SPECIES_SPRITE(RHYPERIOR, gMonBackPic_Rhyperior),
    SPECIES_SPRITE(CINNABAR_FEEBAS, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(WEAVILE, gMonBackPic_Weavile),
    SPECIES_SPRITE(MAMOSWINE, gMonBackPic_Mamoswine),
    SPECIES_SPRITE(FROSLASS, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(MAGMORTAR, gMonBackPic_Magmortar),
    SPECIES_SPRITE(KABUSTAR, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(KABUKNIGHT, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(AMUNYTE, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(KINKABUTO, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(AEROPTERYX, gMonBackPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(FARFETCHD_GALARIAN, gMonBackPic_GalarianFarfetchd),
    ...
    SPECIES_SPRITE(RATTATA_ALOLAN, gMonBackPic_AlolanRattata),
    SPECIES_SPRITE(RATICATE_ALOLAN, gMonBackPic_AlolanRaticate),
    SPECIES_SPRITE(PICHU_ALOLAN, gMonBackPic_RegionalPosePichu),
    SPECIES_SPRITE(PIKACHU_ALOLAN, gMonBackPic_RegionalPosePikachu),
    SPECIES_SPRITE(RAICHU_ALOLAN, gMonBackPic_AlolanRaichu),
    SPECIES_SPRITE(SANDSHREW_ALOLAN, gMonBackPic_AlolanSandshrew),
    SPECIES_SPRITE(SANDSLASH_ALOLAN, gMonBackPic_AlolanSandslash),
    SPECIES_SPRITE(DIGLETT_ALOLAN, gMonBackPic_AlolanDiglett),
    SPECIES_SPRITE(DUGTRIO_ALOLAN, gMonBackPic_AlolanDugtrio),
    SPECIES_SPRITE(MEOWTH_ALOLAN, gMonBackPic_AlolanMeowth),
    SPECIES_SPRITE(PERSIAN_ALOLAN, gMonBackPic_AlolanPersian),
    SPECIES_SPRITE(MEOWTH_GALARIAN, gMonBackPic_GalarianMeowth),
    SPECIES_SPRITE(PERRSERKER, gMonBackPic_GalarianPerrserker),
    SPECIES_SPRITE(GEODUDE_ALOLAN, gMonBackPic_AlolanGeodude),
    SPECIES_SPRITE(GRAVELER_ALOLAN, gMonBackPic_AlolanGraveler),
    SPECIES_SPRITE(GOLEM_ALOLAN, gMonBackPic_AlolanGolem),
    SPECIES_SPRITE(GRIMER_ALOLAN, gMonBackPic_AlolanGrimer),
    SPECIES_SPRITE(MUK_ALOLAN, gMonBackPic_AlolanMuk),
    SPECIES_SPRITE(VULPIX_ALOLAN, gMonBackPic_AlolanVulpix),
    SPECIES_SPRITE(NINETALES_ALOLAN, gMonBackPic_AlolanNinetales),
    SPECIES_SPRITE(EXEGGCUTE_ALOLAN, gMonBackPic_RegionalPoseExeggcute),
    SPECIES_SPRITE(EXEGGUTOR_ALOLAN, gMonBackPic_AlolanExeggutor),
    SPECIES_SPRITE(CUBONE_ALOLAN, gMonBackPic_RegionalPoseCubone),
    SPECIES_SPRITE(MAROWAK_ALOLAN, gMonBackPic_AlolanMarowak),
    SPECIES_SPRITE(CORSOLA_GALARIAN, gMonBackPic_GalarianCorsola),
    SPECIES_SPRITE(CURSOLA, gMonBackPic_GalarianCursola),
    SPECIES_SPRITE(KOFFING_GALARIAN, gMonBackPic_RegionalPoseKoffing),
    SPECIES_SPRITE(WEEZING_GALARIAN, gMonBackPic_GalarianWeezing),
