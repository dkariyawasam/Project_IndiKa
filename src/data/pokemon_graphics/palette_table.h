const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(MAGNEMITE, gMonPalette_Magneton),
    ...
    SPECIES_PAL(LICKITUNG, gMonPalette_Lickilicky),
    ...
    SPECIES_PAL(ELECTABUZZ, gMonPalette_Electivire),
    ...
    SPECIES_PAL(CINNABAR_MAGIKARP, gMonPalette_CinnabarMagikarp),
    ...
    SPECIES_PAL(SENTRET, gMonPalette_Furret),
    ...
    SPECIES_PAL(AIPOM, gMonPalette_Ambipom),
    ...
    SPECIES_PAL(WOBBUFFET, gMonPalette_Wynaut),
    ...
    SPECIES_PAL(ELEKID, gMonPalette_Electivire),
    ...
    SPECIES_PAL(TREECKO, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(GROVYLE, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(SCEPTILE, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(TORCHIC, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(COMBUSKEN, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(BLAZIKEN, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(MUDKIP, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(MARSHTOMP, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(SWAMPERT, gMonPalette_DoubleQuestionMark),
    ...
    SPECIES_PAL(LOTAD, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(LOMBRE, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(LUDICOLO, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(SEEDOT, gMonPalette_Nuzleaf),
    ...
    SPECIES_PAL(SURSKIT, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(MASQUERAIN, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(WAILMER, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(WAILORD, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(SKITTY, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(DELCATTY, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(KECLEON, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(BALTOY, gMonPalette_Baltoy),
    SPECIES_PAL(CLAYDOL, gMonPalette_Claydol),
    SPECIES_PAL(NOSEPASS, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(TORKOAL, gMonPalette_DoubleQuestionMark),
    ...
    SPECIES_PAL(CORPHISH, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(CRAWDAUNT, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(FEEBAS, gMonPalette_Feebas),
    SPECIES_PAL(MILOTIC, gMonPalette_Milotic),
    SPECIES_PAL(CARVANHA, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(SHARPEDO, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(TRAPINCH, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(VIBRAVA, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(FLYGON, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(MAKUHITA, gMonPalette_Makuhita),
    SPECIES_PAL(HARIYAMA, gMonPalette_Hariyama),
    SPECIES_PAL(ELECTRIKE, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(MANECTRIC, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(NUMEL, gMonPalette_Numel),
    SPECIES_PAL(CAMERUPT, gMonPalette_Camerupt),
    SPECIES_PAL(SPHEAL, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(SEALEO, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(WALREIN, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(CACNEA, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(CACTURNE, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(SNORUNT, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(GLALIE, gMonPalette_DoubleQuestionMark),
    ...
    SPECIES_PAL(TROPIUS, gMonPalette_DoubleQuestionMark),
    ...
    SPECIES_PAL(SHUPPET, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(BANETTE, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(SEVIPER, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(ZANGOOSE, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(RELICANTH, gMonPalette_Relicanth),
    SPECIES_PAL(ARON, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(LAIRON, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(AGGRON, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(CASTFORM, gMonPalette_DoubleQuestionMark),
    ...
    SPECIES_PAL(BAGON, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(SHELGON, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(SALAMENCE, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(BELDUM, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(METANG, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(METAGROSS, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(REGIROCK, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(REGICE, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(REGISTEEL, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(KYOGRE, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(GROUDON, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(RAYQUAZA, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(LATIAS, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(LATIOS, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(JIRACHI, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(DEOXYS, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(CHIMECHO, gMonPalette_Chimecho),
    SPECIES_PAL(BUNEARY, gMonPalette_Buneary),
    SPECIES_PAL(LOPUNNY, gMonPalette_Buneary),
    SPECIES_PAL(OMATO, gMonPalette_Omato),
    SPECIES_PAL(OMATOPS, gMonPalette_Omatops),
    SPECIES_PAL(STARLY, gMonPalette_Staraptor),
    SPECIES_PAL(STARAVIA, gMonPalette_Staraptor),
    ...
    SPECIES_PAL(MAGNEZONE, gMonPalette_Magneton),
    ...
    SPECIES_PAL(BRONZOR, gMonPalette_Bronzong),
    SPECIES_PAL(BRONZONG, gMonPalette_Bronzong),
    SPECIES_PAL(MIME_JR, gMonPalette_Mrmime),
    SPECIES_PAL(MIME_SR, gMonPalette_Mrmime),
    SPECIES_PAL(MISMAGIUS, gMonPalette_Mismagius),
    SPECIES_PAL(SPIRITOMB, gMonPalette_DoubleQuestionMark),
    ...
    SPECIES_PAL(KABUSTAR, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(KABUKNIGHT, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(AMUNYTE, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(KINKABUTO, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(AEROPTERYX, gMonPalette_DoubleQuestionMark),
    ...
    SPECIES_PAL(FARFETCHD_GALARIAN, gMonPalette_GalarianFarfetchd),
    ...
    SPECIES_PAL(RATTATA_ALOLAN, gMonPalette_AlolanRattata),
    SPECIES_PAL(RATICATE_ALOLAN, gMonPalette_AlolanRaticate),
    SPECIES_PAL(PICHU_ALOLAN, gMonPalette_Pichu),
    SPECIES_PAL(PIKACHU_ALOLAN, gMonPalette_Pikachu),
    SPECIES_PAL(RAICHU_ALOLAN, gMonPalette_AlolanRaichu),
    SPECIES_PAL(SANDSHREW_ALOLAN, gMonPalette_AlolanSandshrew),
    SPECIES_PAL(SANDSLASH_ALOLAN, gMonPalette_AlolanSandslash),
    SPECIES_PAL(DIGLETT_ALOLAN, gMonPalette_AlolanDiglett),
    SPECIES_PAL(DUGTRIO_ALOLAN, gMonPalette_AlolanDugtrio),
    SPECIES_PAL(MEOWTH_ALOLAN, gMonPalette_AlolanMeowth),
    SPECIES_PAL(PERSIAN_ALOLAN, gMonPalette_AlolanPersian),
    SPECIES_PAL(MEOWTH_GALARIAN, gMonPalette_GalarianMeowth),
    SPECIES_PAL(PERRSERKER, gMonPalette_GalarianPerrserker),
    SPECIES_PAL(GEODUDE_ALOLAN, gMonPalette_AlolanGeodude),
    SPECIES_PAL(GRAVELER_ALOLAN, gMonPalette_AlolanGraveler),
    SPECIES_PAL(GOLEM_ALOLAN, gMonPalette_AlolanGolem),
    SPECIES_PAL(GRIMER_ALOLAN, gMonPalette_AlolanGrimer),
    SPECIES_PAL(MUK_ALOLAN, gMonPalette_AlolanMuk),
    SPECIES_PAL(VULPIX_ALOLAN, gMonPalette_AlolanVulpix),
    SPECIES_PAL(NINETALES_ALOLAN, gMonPalette_AlolanNinetales),
    SPECIES_PAL(EXEGGCUTE_ALOLAN, gMonPalette_Exeggcute),
    SPECIES_PAL(EXEGGUTOR_ALOLAN, gMonPalette_AlolanExeggutor),
    SPECIES_PAL(CUBONE_ALOLAN, gMonPalette_Cubone),
    SPECIES_PAL(MAROWAK_ALOLAN, gMonPalette_AlolanMarowak),
    SPECIES_PAL(CORSOLA_GALARIAN, gMonPalette_GalarianCorsola),
    SPECIES_PAL(CURSOLA, gMonPalette_GalarianCursola),
    SPECIES_PAL(KOFFING_GALARIAN, gMonPalette_Koffing),
    SPECIES_PAL(WEEZING_GALARIAN, gMonPalette_GalarianWeezing),
    SPECIES_PAL(KRICKETOT, gMonPalette_Kricketot),
    SPECIES_PAL(KRICKETUNE, gMonPalette_Kricketot),
