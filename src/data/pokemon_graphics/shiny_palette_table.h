const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(MAGNEMITE, gMonShinyPalette_Magneton),
    ...
    SPECIES_SHINY_PAL(LICKITUNG, gMonShinyPalette_Lickilicky),
    ...
    SPECIES_SHINY_PAL(ELECTABUZZ, gMonShinyPalette_Electivire),
    ...
    SPECIES_SHINY_PAL(CINNABAR_MAGIKARP, gMonShinyPalette_CinnabarMagikarp),
    ...
    SPECIES_SHINY_PAL(SENTRET, gMonShinyPalette_Furret),
    ...
    SPECIES_SHINY_PAL(AIPOM, gMonShinyPalette_Ambipom),
    ...
    SPECIES_SHINY_PAL(WOBBUFFET, gMonShinyPalette_Wynaut),
    ...
    SPECIES_SHINY_PAL(ELEKID, gMonShinyPalette_Electivire),
    ...
    SPECIES_SHINY_PAL(TREECKO, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(GROVYLE, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(SCEPTILE, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(TORCHIC, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(COMBUSKEN, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(BLAZIKEN, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(MUDKIP, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(MARSHTOMP, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(SWAMPERT, gMonShinyPalette_DoubleQuestionMark),
    ...
    SPECIES_SHINY_PAL(LOTAD, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(LOMBRE, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(LUDICOLO, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(SEEDOT, gMonShinyPalette_Nuzleaf),
    ...
    SPECIES_SHINY_PAL(SURSKIT, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(MASQUERAIN, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(WAILMER, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(WAILORD, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(SKITTY, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(DELCATTY, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(KECLEON, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(BALTOY, gMonShinyPalette_Baltoy),
    SPECIES_SHINY_PAL(CLAYDOL, gMonShinyPalette_Claydol),
    SPECIES_SHINY_PAL(NOSEPASS, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(TORKOAL, gMonShinyPalette_DoubleQuestionMark),
    ...
    SPECIES_SHINY_PAL(CORPHISH, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(CRAWDAUNT, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(FEEBAS, gMonShinyPalette_Feebas),
    SPECIES_SHINY_PAL(MILOTIC, gMonShinyPalette_Milotic),
    SPECIES_SHINY_PAL(CARVANHA, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(SHARPEDO, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(TRAPINCH, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(VIBRAVA, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(FLYGON, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(MAKUHITA, gMonShinyPalette_Makuhita),
    SPECIES_SHINY_PAL(HARIYAMA, gMonShinyPalette_Hariyama),
    SPECIES_SHINY_PAL(ELECTRIKE, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(MANECTRIC, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(NUMEL, gMonShinyPalette_Numel),
    SPECIES_SHINY_PAL(CAMERUPT, gMonShinyPalette_Camerupt),
    SPECIES_SHINY_PAL(SPHEAL, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(SEALEO, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(WALREIN, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(CACNEA, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(CACTURNE, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(SNORUNT, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(GLALIE, gMonShinyPalette_DoubleQuestionMark),
    ...
    SPECIES_SHINY_PAL(TROPIUS, gMonShinyPalette_DoubleQuestionMark),
    ...
    SPECIES_SHINY_PAL(SHUPPET, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(BANETTE, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(SEVIPER, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(ZANGOOSE, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(RELICANTH, gMonShinyPalette_Relicanth),
    SPECIES_SHINY_PAL(ARON, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(LAIRON, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(AGGRON, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(CASTFORM, gMonShinyPalette_DoubleQuestionMark),
    ...
    SPECIES_SHINY_PAL(BAGON, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(SHELGON, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(SALAMENCE, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(BELDUM, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(METANG, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(METAGROSS, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(REGIROCK, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(REGICE, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(REGISTEEL, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(KYOGRE, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(GROUDON, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(RAYQUAZA, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(LATIAS, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(LATIOS, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(JIRACHI, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(DEOXYS, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(CHIMECHO, gMonShinyPalette_Chimecho),
    SPECIES_SHINY_PAL(BUNEARY, gMonShinyPalette_Buneary),
    SPECIES_SHINY_PAL(LOPUNNY, gMonShinyPalette_Buneary),
    SPECIES_SHINY_PAL(OMATO, gMonShinyPalette_Omato),
    SPECIES_SHINY_PAL(OMATOPS, gMonShinyPalette_Omatops),
    SPECIES_SHINY_PAL(STARLY, gMonShinyPalette_Staraptor),
    SPECIES_SHINY_PAL(STARAVIA, gMonShinyPalette_Staraptor),
    ...
    SPECIES_SHINY_PAL(MAGNEZONE, gMonShinyPalette_Magneton),
    ...
    SPECIES_SHINY_PAL(BRONZOR, gMonShinyPalette_Bronzong),
    SPECIES_SHINY_PAL(BRONZONG, gMonShinyPalette_Bronzong),
    SPECIES_SHINY_PAL(MIME_JR, gMonShinyPalette_Mrmime),
    SPECIES_SHINY_PAL(MIME_SR, gMonShinyPalette_Mrmime),
    SPECIES_SHINY_PAL(MISMAGIUS, gMonShinyPalette_Mismagius),
    SPECIES_SHINY_PAL(SPIRITOMB, gMonShinyPalette_DoubleQuestionMark),
    ...
    SPECIES_SHINY_PAL(KABUSTAR, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(KABUKNIGHT, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(AMUNYTE, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(KINKABUTO, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(AEROPTERYX, gMonShinyPalette_DoubleQuestionMark),
    ...
    SPECIES_SHINY_PAL(FARFETCHD_GALARIAN, gMonShinyPalette_GalarianFarfetchd),
    ...
    SPECIES_SHINY_PAL(RATTATA_ALOLAN, gMonShinyPalette_AlolanRattata),
    SPECIES_SHINY_PAL(RATICATE_ALOLAN, gMonShinyPalette_AlolanRaticate),
    SPECIES_SHINY_PAL(PICHU_ALOLAN, gMonShinyPalette_Pichu),
    SPECIES_SHINY_PAL(PIKACHU_ALOLAN, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(RAICHU_ALOLAN, gMonShinyPalette_AlolanRaichu),
    SPECIES_SHINY_PAL(SANDSHREW_ALOLAN, gMonShinyPalette_AlolanSandshrew),
    SPECIES_SHINY_PAL(SANDSLASH_ALOLAN, gMonShinyPalette_AlolanSandslash),
    SPECIES_SHINY_PAL(DIGLETT_ALOLAN, gMonShinyPalette_AlolanDiglett),
    SPECIES_SHINY_PAL(DUGTRIO_ALOLAN, gMonShinyPalette_AlolanDugtrio),
    SPECIES_SHINY_PAL(MEOWTH_ALOLAN, gMonShinyPalette_AlolanMeowth),
    SPECIES_SHINY_PAL(PERSIAN_ALOLAN, gMonShinyPalette_AlolanPersian),
    SPECIES_SHINY_PAL(MEOWTH_GALARIAN, gMonShinyPalette_GalarianMeowth),
    SPECIES_SHINY_PAL(PERRSERKER, gMonShinyPalette_GalarianPerrserker),
    SPECIES_SHINY_PAL(GEODUDE_ALOLAN, gMonShinyPalette_AlolanGeodude),
    SPECIES_SHINY_PAL(GRAVELER_ALOLAN, gMonShinyPalette_AlolanGraveler),
    SPECIES_SHINY_PAL(GOLEM_ALOLAN, gMonShinyPalette_AlolanGolem),
    SPECIES_SHINY_PAL(GRIMER_ALOLAN, gMonShinyPalette_AlolanGrimer),
    SPECIES_SHINY_PAL(MUK_ALOLAN, gMonShinyPalette_AlolanMuk),
    SPECIES_SHINY_PAL(VULPIX_ALOLAN, gMonShinyPalette_AlolanVulpix),
    SPECIES_SHINY_PAL(NINETALES_ALOLAN, gMonShinyPalette_AlolanNinetales),
    SPECIES_SHINY_PAL(EXEGGCUTE_ALOLAN, gMonShinyPalette_Exeggcute),
    SPECIES_SHINY_PAL(EXEGGUTOR_ALOLAN, gMonShinyPalette_AlolanExeggutor),
    SPECIES_SHINY_PAL(CUBONE_ALOLAN, gMonShinyPalette_Cubone),
    SPECIES_SHINY_PAL(MAROWAK_ALOLAN, gMonShinyPalette_AlolanMarowak),
    SPECIES_SHINY_PAL(CORSOLA_GALARIAN, gMonShinyPalette_GalarianCorsola),
    SPECIES_SHINY_PAL(CURSOLA, gMonShinyPalette_GalarianCursola),
    SPECIES_SHINY_PAL(KOFFING_GALARIAN, gMonShinyPalette_Koffing),
    SPECIES_SHINY_PAL(WEEZING_GALARIAN, gMonShinyPalette_GalarianWeezing),
    SPECIES_SHINY_PAL(KRICKETOT, gMonShinyPalette_Kricketot),
    SPECIES_SHINY_PAL(KRICKETUNE, gMonShinyPalette_Kricketot),
