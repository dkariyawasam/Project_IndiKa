const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_CINNABAR_MAGIKARP] = gMonFootprint_CinnabarMagikarp,
    ...
    [SPECIES_TREECKO] = gMonFootprint_QuestionMark,
    [SPECIES_GROVYLE] = gMonFootprint_QuestionMark,
    [SPECIES_SCEPTILE] = gMonFootprint_QuestionMark,
    [SPECIES_TORCHIC] = gMonFootprint_QuestionMark,
    [SPECIES_COMBUSKEN] = gMonFootprint_QuestionMark,
    [SPECIES_BLAZIKEN] = gMonFootprint_QuestionMark,
    [SPECIES_MUDKIP] = gMonFootprint_QuestionMark,
    [SPECIES_MARSHTOMP] = gMonFootprint_QuestionMark,
    [SPECIES_SWAMPERT] = gMonFootprint_QuestionMark,
    ...
    [SPECIES_LOTAD] = gMonFootprint_QuestionMark,
    [SPECIES_LOMBRE] = gMonFootprint_QuestionMark,
    [SPECIES_LUDICOLO] = gMonFootprint_QuestionMark,
    ...
    [SPECIES_SURSKIT] = gMonFootprint_QuestionMark,
    [SPECIES_MASQUERAIN] = gMonFootprint_QuestionMark,
    [SPECIES_WAILMER] = gMonFootprint_QuestionMark,
    [SPECIES_WAILORD] = gMonFootprint_QuestionMark,
    [SPECIES_SKITTY] = gMonFootprint_QuestionMark,
    [SPECIES_DELCATTY] = gMonFootprint_QuestionMark,
    [SPECIES_KECLEON] = gMonFootprint_QuestionMark,
    [SPECIES_BALTOY] = gMonFootprint_Baltoy,
    [SPECIES_CLAYDOL] = gMonFootprint_Claydol,
    [SPECIES_NOSEPASS] = gMonFootprint_QuestionMark,
    [SPECIES_TORKOAL] = gMonFootprint_QuestionMark,
    ...
    [SPECIES_CORPHISH] = gMonFootprint_QuestionMark,
    [SPECIES_CRAWDAUNT] = gMonFootprint_QuestionMark,
    [SPECIES_FEEBAS] = gMonFootprint_Feebas,
    [SPECIES_MILOTIC] = gMonFootprint_Milotic,
    [SPECIES_CARVANHA] = gMonFootprint_QuestionMark,
    [SPECIES_SHARPEDO] = gMonFootprint_QuestionMark,
    [SPECIES_TRAPINCH] = gMonFootprint_QuestionMark,
    [SPECIES_VIBRAVA] = gMonFootprint_QuestionMark,
    [SPECIES_FLYGON] = gMonFootprint_QuestionMark,
    [SPECIES_MAKUHITA] = gMonFootprint_Makuhita,
    [SPECIES_HARIYAMA] = gMonFootprint_Hariyama,
    [SPECIES_ELECTRIKE] = gMonFootprint_QuestionMark,
    [SPECIES_MANECTRIC] = gMonFootprint_QuestionMark,
    [SPECIES_NUMEL] = gMonFootprint_Numel,
    [SPECIES_CAMERUPT] = gMonFootprint_Camerupt,
    [SPECIES_SPHEAL] = gMonFootprint_QuestionMark,
    [SPECIES_SEALEO] = gMonFootprint_QuestionMark,
    [SPECIES_WALREIN] = gMonFootprint_QuestionMark,
    [SPECIES_CACNEA] = gMonFootprint_QuestionMark,
    [SPECIES_CACTURNE] = gMonFootprint_QuestionMark,
    [SPECIES_SNORUNT] = gMonFootprint_QuestionMark,
    [SPECIES_GLALIE] = gMonFootprint_QuestionMark,
    ...
    [SPECIES_TROPIUS] = gMonFootprint_QuestionMark,
    ...
    [SPECIES_SHUPPET] = gMonFootprint_QuestionMark,
    [SPECIES_BANETTE] = gMonFootprint_QuestionMark,
    [SPECIES_SEVIPER] = gMonFootprint_QuestionMark,
    [SPECIES_ZANGOOSE] = gMonFootprint_QuestionMark,
    [SPECIES_RELICANTH] = gMonFootprint_Relicanth,
    [SPECIES_ARON] = gMonFootprint_QuestionMark,
    [SPECIES_LAIRON] = gMonFootprint_QuestionMark,
    [SPECIES_AGGRON] = gMonFootprint_QuestionMark,
    [SPECIES_CASTFORM] = gMonFootprint_QuestionMark,
    ...
    [SPECIES_BAGON] = gMonFootprint_QuestionMark,
    [SPECIES_SHELGON] = gMonFootprint_QuestionMark,
    [SPECIES_SALAMENCE] = gMonFootprint_QuestionMark,
    [SPECIES_BELDUM] = gMonFootprint_QuestionMark,
    [SPECIES_METANG] = gMonFootprint_QuestionMark,
    [SPECIES_METAGROSS] = gMonFootprint_QuestionMark,
    [SPECIES_REGIROCK] = gMonFootprint_QuestionMark,
    [SPECIES_REGICE] = gMonFootprint_QuestionMark,
    [SPECIES_REGISTEEL] = gMonFootprint_QuestionMark,
    [SPECIES_KYOGRE] = gMonFootprint_QuestionMark,
    [SPECIES_GROUDON] = gMonFootprint_QuestionMark,
    [SPECIES_RAYQUAZA] = gMonFootprint_QuestionMark,
    [SPECIES_LATIAS] = gMonFootprint_QuestionMark,
    [SPECIES_LATIOS] = gMonFootprint_QuestionMark,
    [SPECIES_JIRACHI] = gMonFootprint_QuestionMark,
    [SPECIES_DEOXYS] = gMonFootprint_QuestionMark,
    ...
    [SPECIES_MIME_SR] = gMonFootprint_MimeSr,
    [SPECIES_MISMAGIUS] = gMonFootprint_Mismagius,
    [SPECIES_SPIRITOMB] = gMonFootprint_QuestionMark,
    [SPECIES_DUSKNOIR] = gMonFootprint_Dusknoir,
    [SPECIES_OSSCYTHE] = gMonFootprint_Osscythe,
    [SPECIES_RHYPERIOR] = gMonFootprint_Rhyperior,
    [SPECIES_CINNABAR_FEEBAS] = gMonFootprint_QuestionMark,
    [SPECIES_WEAVILE] = gMonFootprint_Weavile,
    [SPECIES_MAMOSWINE] = gMonFootprint_Mamoswine,
    [SPECIES_FROSLASS] = gMonFootprint_QuestionMark,
    [SPECIES_MAGMORTAR] = gMonFootprint_Magmortar,
    [SPECIES_KABUSTAR] = gMonFootprint_QuestionMark,
    [SPECIES_KABUKNIGHT] = gMonFootprint_QuestionMark,
    [SPECIES_AMUNYTE] = gMonFootprint_QuestionMark,
    [SPECIES_KINKABUTO] = gMonFootprint_QuestionMark,
    [SPECIES_AEROPTERYX] = gMonFootprint_QuestionMark,
    ...
    [SPECIES_PICHU_ALOLAN] = gMonFootprint_Pichu,
    ...
    [SPECIES_PERRSERKER] = gMonFootprint_GalarianPerrserker,
    ...
    [SPECIES_CURSOLA] = gMonFootprint_GalarianCursola,
