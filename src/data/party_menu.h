...
} const sCursorOptions[] =
{
    ...
    [CURSOR_OPTION_CANCEL1]                              = {gApexLogText_Cancel,      CursorCB_Cancel1  },
    ...
    [CURSOR_OPTION_CANCEL2]                              = {gApexLogText_Cancel,      CursorCB_Cancel2  },
...
{
    MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_ROCK_SMASH, MOVE_WATERFALL, MOVE_TELEPORT,
