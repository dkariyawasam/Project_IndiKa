...
static const u32 sTMHMLearnsets[][2] =
{
    ...
    [SPECIES_REGIROCK] = TMHM_LEARNSET(0),

    [SPECIES_REGICE] = TMHM_LEARNSET(0),

    [SPECIES_REGISTEEL] = TMHM_LEARNSET(0),

    [SPECIES_KYOGRE]      = TMHM_LEARNSET(0),
    [SPECIES_GROUDON]     = TMHM_LEARNSET(0),
    [SPECIES_RAYQUAZA]    = TMHM_LEARNSET(0),
    [SPECIES_LATIAS]      = TMHM_LEARNSET(0),
    [SPECIES_LATIOS]      = TMHM_LEARNSET(0),
    [SPECIES_JIRACHI]     = TMHM_LEARNSET(0),
    [SPECIES_DEOXYS]      = TMHM_LEARNSET(0),
    ...
    [SPECIES_LOPUNNY]     = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
                                        ...
                                        | TMHM(TM44_REST)
                                        | TMHM(TM51_CUT)),
    [SPECIES_OMATO]      = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
                                        | TMHM(TM03_WATER_PULSE)
                                        | TMHM(TM04_CALM_MIND)
                                        | TMHM(TM06_TOXIC)
                                        | TMHM(TM10_HIDDEN_POWER)
                                        | TMHM(TM11_SUNNY_DAY)
                                        | TMHM(TM12_TAUNT)),
    [SPECIES_OMATOPS]     = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
                                        | TMHM(TM03_WATER_PULSE)
                                        | TMHM(TM04_CALM_MIND)
                                        | TMHM(TM06_TOXIC)
                                        | TMHM(TM10_HIDDEN_POWER)
    ...
    [SPECIES_MIME_JR]     = TMHM_LEARNSET(TMHM(TM04_CALM_MIND)
                                        | TMHM(TM06_TOXIC)
                                        | TMHM(TM10_HIDDEN_POWER)
                                        | TMHM(TM11_SUNNY_DAY)
                                        | TMHM(TM16_LIGHT_SCREEN)
    ...
    [SPECIES_MIME_SR]     = TMHM_LEARNSET(TMHM(TM04_CALM_MIND)
                                        | TMHM(TM06_TOXIC)
                                        | TMHM(TM10_HIDDEN_POWER)
                                        | TMHM(TM11_SUNNY_DAY)
                                        | TMHM(TM15_HYPER_BEAM)
    ...
    [SPECIES_WEEZING_GALARIAN] = TMHM_LEARNSET(TMHM(TM06_TOXIC)
                                        | TMHM(TM10_HIDDEN_POWER)
                                        | TMHM(TM11_SUNNY_DAY)
                                        | TMHM(TM12_TAUNT)
                                        | TMHM(TM15_HYPER_BEAM)
