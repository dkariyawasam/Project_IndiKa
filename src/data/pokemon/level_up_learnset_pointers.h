const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_CINNABAR_MAGIKARP] = sCinnabarMagikarpLevelUpLearnset,
    ...
    [SPECIES_TREECKO] = sPlaceholderLevelUpLearnset,
    [SPECIES_GROVYLE] = sPlaceholderLevelUpLearnset,
    [SPECIES_SCEPTILE] = sPlaceholderLevelUpLearnset,
    [SPECIES_TORCHIC] = sPlaceholderLevelUpLearnset,
    [SPECIES_COMBUSKEN] = sPlaceholderLevelUpLearnset,
    [SPECIES_BLAZIKEN] = sPlaceholderLevelUpLearnset,
    [SPECIES_MUDKIP] = sPlaceholderLevelUpLearnset,
    [SPECIES_MARSHTOMP] = sPlaceholderLevelUpLearnset,
    [SPECIES_SWAMPERT] = sPlaceholderLevelUpLearnset,
    ...
    [SPECIES_LOTAD] = sPlaceholderLevelUpLearnset,
    [SPECIES_LOMBRE] = sPlaceholderLevelUpLearnset,
    [SPECIES_LUDICOLO] = sPlaceholderLevelUpLearnset,
    ...
    [SPECIES_SURSKIT] = sPlaceholderLevelUpLearnset,
    [SPECIES_MASQUERAIN] = sPlaceholderLevelUpLearnset,
    [SPECIES_WAILMER] = sPlaceholderLevelUpLearnset,
    [SPECIES_WAILORD] = sPlaceholderLevelUpLearnset,
    [SPECIES_SKITTY] = sPlaceholderLevelUpLearnset,
    [SPECIES_DELCATTY] = sPlaceholderLevelUpLearnset,
    [SPECIES_KECLEON] = sPlaceholderLevelUpLearnset,
    [SPECIES_BALTOY] = sBaltoyLevelUpLearnset,
    [SPECIES_CLAYDOL] = sClaydolLevelUpLearnset,
    [SPECIES_NOSEPASS] = sPlaceholderLevelUpLearnset,
    [SPECIES_TORKOAL] = sPlaceholderLevelUpLearnset,
    ...
    [SPECIES_CORPHISH] = sPlaceholderLevelUpLearnset,
    [SPECIES_CRAWDAUNT] = sPlaceholderLevelUpLearnset,
    [SPECIES_FEEBAS] = sFeebasLevelUpLearnset,
    [SPECIES_MILOTIC] = sMiloticLevelUpLearnset,
    [SPECIES_CARVANHA] = sPlaceholderLevelUpLearnset,
    [SPECIES_SHARPEDO] = sPlaceholderLevelUpLearnset,
    [SPECIES_TRAPINCH] = sPlaceholderLevelUpLearnset,
    [SPECIES_VIBRAVA] = sPlaceholderLevelUpLearnset,
    [SPECIES_FLYGON] = sPlaceholderLevelUpLearnset,
    [SPECIES_MAKUHITA] = sMakuhitaLevelUpLearnset,
    [SPECIES_HARIYAMA] = sHariyamaLevelUpLearnset,
    [SPECIES_ELECTRIKE] = sPlaceholderLevelUpLearnset,
    [SPECIES_MANECTRIC] = sPlaceholderLevelUpLearnset,
    [SPECIES_NUMEL] = sNumelLevelUpLearnset,
    [SPECIES_CAMERUPT] = sCameruptLevelUpLearnset,
    [SPECIES_SPHEAL] = sPlaceholderLevelUpLearnset,
    [SPECIES_SEALEO] = sPlaceholderLevelUpLearnset,
    [SPECIES_WALREIN] = sPlaceholderLevelUpLearnset,
    [SPECIES_CACNEA] = sPlaceholderLevelUpLearnset,
    [SPECIES_CACTURNE] = sPlaceholderLevelUpLearnset,
    [SPECIES_SNORUNT] = sPlaceholderLevelUpLearnset,
    [SPECIES_GLALIE] = sPlaceholderLevelUpLearnset,
    ...
    [SPECIES_TROPIUS] = sPlaceholderLevelUpLearnset,
    ...
    [SPECIES_SHUPPET] = sPlaceholderLevelUpLearnset,
    [SPECIES_BANETTE] = sPlaceholderLevelUpLearnset,
    [SPECIES_SEVIPER] = sPlaceholderLevelUpLearnset,
    [SPECIES_ZANGOOSE] = sPlaceholderLevelUpLearnset,
    [SPECIES_RELICANTH] = sRelicanthLevelUpLearnset,
    [SPECIES_ARON] = sPlaceholderLevelUpLearnset,
    [SPECIES_LAIRON] = sPlaceholderLevelUpLearnset,
    [SPECIES_AGGRON] = sPlaceholderLevelUpLearnset,
    [SPECIES_CASTFORM] = sPlaceholderLevelUpLearnset,
    ...
    [SPECIES_BAGON] = sPlaceholderLevelUpLearnset,
    [SPECIES_SHELGON] = sPlaceholderLevelUpLearnset,
    [SPECIES_SALAMENCE] = sPlaceholderLevelUpLearnset,
    [SPECIES_BELDUM] = sPlaceholderLevelUpLearnset,
    [SPECIES_METANG] = sPlaceholderLevelUpLearnset,
    [SPECIES_METAGROSS] = sPlaceholderLevelUpLearnset,
    [SPECIES_REGIROCK] = sPlaceholderLevelUpLearnset,
    [SPECIES_REGICE] = sPlaceholderLevelUpLearnset,
    [SPECIES_REGISTEEL] = sPlaceholderLevelUpLearnset,
    [SPECIES_KYOGRE] = sPlaceholderLevelUpLearnset,
    [SPECIES_GROUDON] = sPlaceholderLevelUpLearnset,
    [SPECIES_RAYQUAZA] = sPlaceholderLevelUpLearnset,
    [SPECIES_LATIAS] = sPlaceholderLevelUpLearnset,
    [SPECIES_LATIOS] = sPlaceholderLevelUpLearnset,
    [SPECIES_JIRACHI] = sPlaceholderLevelUpLearnset,
    [SPECIES_DEOXYS] = sPlaceholderLevelUpLearnset,
    ...
    [SPECIES_MIME_SR] = sMimeSrLevelUpLearnset,
    [SPECIES_MISMAGIUS] = sMismagiusLevelUpLearnset,
    [SPECIES_SPIRITOMB] = sPlaceholderLevelUpLearnset,
    [SPECIES_DUSKNOIR] = sDusknoirLevelUpLearnset,
    [SPECIES_OSSCYTHE] = sOsscytheLevelUpLearnset,
    [SPECIES_RHYPERIOR] = sRhyperiorLevelUpLearnset,
    [SPECIES_CINNABAR_FEEBAS] = sCinnabarFeebasLevelUpLearnset,
    [SPECIES_WEAVILE] = sWeavileLevelUpLearnset,
    [SPECIES_MAMOSWINE] = sMamoswineLevelUpLearnset,
    [SPECIES_FROSLASS] = sPlaceholderLevelUpLearnset,
    [SPECIES_MAGMORTAR] = sMagmortarLevelUpLearnset,
    [SPECIES_KABUSTAR] = sKabustarLevelUpLearnset,
    [SPECIES_KABUKNIGHT] = sKabuknightLevelUpLearnset,
    [SPECIES_AMUNYTE] = sAmunyteLevelUpLearnset,
    [SPECIES_KINKABUTO] = sKinkabutoLevelUpLearnset,
    [SPECIES_AEROPTERYX] = sAeropteryxLevelUpLearnset,
    ...
    [SPECIES_RATTATA_ALOLAN] = sRattataLevelUpLearnset,
    [SPECIES_RATICATE_ALOLAN] = sRaticateLevelUpLearnset,
    [SPECIES_PICHU_ALOLAN] = sPichuLevelUpLearnset,
    [SPECIES_PIKACHU_ALOLAN] = sPikachuLevelUpLearnset,
    [SPECIES_RAICHU_ALOLAN] = sRaichuLevelUpLearnset,
    [SPECIES_SANDSHREW_ALOLAN] = sSandshrewLevelUpLearnset,
    [SPECIES_SANDSLASH_ALOLAN] = sSandslashLevelUpLearnset,
    [SPECIES_DIGLETT_ALOLAN] = sDiglettLevelUpLearnset,
    [SPECIES_DUGTRIO_ALOLAN] = sDugtrioLevelUpLearnset,
    [SPECIES_MEOWTH_ALOLAN] = sMeowthLevelUpLearnset,
    [SPECIES_PERSIAN_ALOLAN] = sPersianLevelUpLearnset,
    [SPECIES_MEOWTH_GALARIAN] = sMeowthLevelUpLearnset,
    [SPECIES_PERRSERKER] = sPersianLevelUpLearnset,
    [SPECIES_GEODUDE_ALOLAN] = sGeodudeLevelUpLearnset,
    [SPECIES_GRAVELER_ALOLAN] = sGravelerLevelUpLearnset,
    [SPECIES_GOLEM_ALOLAN] = sGolemLevelUpLearnset,
    [SPECIES_GRIMER_ALOLAN] = sGrimerLevelUpLearnset,
    [SPECIES_MUK_ALOLAN] = sMukLevelUpLearnset,
    [SPECIES_VULPIX_ALOLAN] = sVulpixLevelUpLearnset,
    [SPECIES_NINETALES_ALOLAN] = sNinetalesAlolanLevelUpLearnset,
    [SPECIES_EXEGGCUTE_ALOLAN] = sExeggcuteLevelUpLearnset,
    [SPECIES_EXEGGUTOR_ALOLAN] = sExeggutorLevelUpLearnset,
    [SPECIES_CUBONE_ALOLAN] = sCuboneLevelUpLearnset,
    [SPECIES_MAROWAK_ALOLAN] = sMarowakLevelUpLearnset,
    [SPECIES_CORSOLA_GALARIAN] = sCorsolaLevelUpLearnset,
    [SPECIES_CURSOLA] = sCorsolaLevelUpLearnset,
