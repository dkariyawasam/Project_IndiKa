...
{
    [SPECIES_CHIKORITA - HOENN_MON_SPECIES_START] = 151, // Original Chikorita cry.
    ...
    [SPECIES_LICKILICKY - HOENN_MON_SPECIES_START] = SPECIES_LICKITUNG,
    ...
    [SPECIES_KRICKETOT - HOENN_MON_SPECIES_START] = CRY_NINCADA,
    [SPECIES_KRICKETUNE - HOENN_MON_SPECIES_START] = CRY_NINJASK,
    [SPECIES_GALLADE - HOENN_MON_SPECIES_START] = CRY_GARDEVOIR,
};
