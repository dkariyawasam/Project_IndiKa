const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_RS_COOLTRAINER_M]       = TRAINER_PIC_COOLTRAINER_M,
    [FACILITY_CLASS_RS_COOLTRAINER_F]       = TRAINER_PIC_COOLTRAINER_F,
    ...
    [FACILITY_CLASS_LEADER_BRAWLY]          = TRAINER_PIC_BLACK_BELT,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_RS_COOLTRAINER_M]       = TRAINER_CLASS_COOLTRAINER,
    [FACILITY_CLASS_RS_COOLTRAINER_F]       = TRAINER_CLASS_COOLTRAINER,
    ...
    [FACILITY_CLASS_RS_CAMPER]              = TRAINER_CLASS_SCOUT_M,
