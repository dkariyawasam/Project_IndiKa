const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            ...
                            // Last matching level-up evolution takes priority over day/night friendship.
    ...
    [SPECIES_SNEASEL]    = {{EVO_LEVEL_ITEM_NIGHT, ITEM_RAZOR_CLAW, SPECIES_WEAVILE}},
    ...
    [SPECIES_OMATO]     = {{EVO_LEVEL, 40, SPECIES_OMATOPS}},
    [SPECIES_KABUSTAR]  = {{EVO_LEVEL, 40, SPECIES_KABUKNIGHT}},
    ...
    [SPECIES_TANGELA] = {{EVO_APEX_MOVE, MOVE_ANCIENT_POWER, SPECIES_TANGROWTH}},
    [SPECIES_PRIMEAPE] = {{EVO_APEX_MOVE, MOVE_RAGE_FIST, SPECIES_ANNIHILAPE}},
    [SPECIES_MR_MIME] = {{EVO_APEX_MOVE, MOVE_BARRIER, SPECIES_MIME_SR}},
    [SPECIES_MAROWAK] = {{EVO_APEX_MOVE, MOVE_BONE_RUSH, SPECIES_OSSCYTHE}},
    [SPECIES_LICKITUNG] = {{EVO_APEX_MOVE, MOVE_ROLLOUT, SPECIES_LICKILICKY}},
    [SPECIES_AIPOM] = {{EVO_APEX_MOVE, MOVE_DOUBLE_HIT, SPECIES_AMBIPOM}},
    // Standard evolution links for the active extended roster.
    [SPECIES_TYNAMO] = {{EVO_LEVEL, 39, SPECIES_EELEKTRIK}},
    [SPECIES_EELEKTRIK] = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_EELEKTROSS}},
    [SPECIES_MIME_JR] = {{EVO_LEVEL_MOVE, MOVE_MIMIC, SPECIES_MR_MIME}},
    [SPECIES_COMBEE] = {{EVO_LEVEL_FEMALE, 21, SPECIES_VESPIQUEN}},
    [SPECIES_RATTATA_ALOLAN] = {{EVO_LEVEL_NIGHT, 20, SPECIES_RATICATE_ALOLAN}},
    [SPECIES_PICHU_ALOLAN] = {{EVO_FRIENDSHIP, 0, SPECIES_PIKACHU_ALOLAN}},
    ...
    [SPECIES_CUBONE_ALOLAN] = {{EVO_LEVEL_NIGHT, 28, SPECIES_MAROWAK_ALOLAN}},
