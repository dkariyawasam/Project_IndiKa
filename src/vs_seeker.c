...
static const struct RematchData sRematches[] = {
   { {TRAINER_AROMA_LADY_FLORA, TRAINER_AROMA_LADY_FLORA}, MAP(MAP_CELADON_CITY_GYM) },
   { {TRAINER_AROMA_LADY_DAPHNE, TRAINER_AROMA_LADY_DAPHNE}, MAP(MAP_CELADON_CITY_GYM) },
   { {TRAINER_AROMA_LADY_LAUREL, TRAINER_AROMA_LADY_LAUREL}, MAP(MAP_CELADON_CITY_GYM) },
   { {TRAINER_AROMA_LADY_VIOLA, TRAINER_AROMA_LADY_VIOLA}, MAP(MAP_CELADON_CITY_GYM) },
   { {TRAINER_PKMN_BREEDER_HAZEL, TRAINER_PKMN_BREEDER_HAZEL}, MAP(MAP_CELADON_CITY_GYM) },
   { {TRAINER_PKMN_BREEDER_MABEL, TRAINER_PKMN_BREEDER_MABEL}, MAP(MAP_CELADON_CITY_GYM) },
   { {TRAINER_PSYCHIC_ORIN, TRAINER_PSYCHIC_ORIN}, MAP(MAP_SAFFRON_CITY_GYM) },
   { {TRAINER_PSYCHIC_ALDEN, TRAINER_PSYCHIC_ALDEN}, MAP(MAP_SAFFRON_CITY_GYM) },
   { {TRAINER_PSYCHIC_SILAS, TRAINER_PSYCHIC_SILAS}, MAP(MAP_SAFFRON_CITY_GYM) },
   { {TRAINER_PSYCHIC_MIRA, TRAINER_PSYCHIC_MIRA}, MAP(MAP_SAFFRON_CITY_GYM) },
   { {TRAINER_PSYCHIC_SELENE, TRAINER_PSYCHIC_SELENE}, MAP(MAP_SAFFRON_CITY_GYM) },
   { {TRAINER_PSYCHIC_LYRA, TRAINER_PSYCHIC_LYRA}, MAP(MAP_SAFFRON_CITY_GYM) },
   ...
   { {TRAINER_TRENDSETTER_DAWN, TRAINER_LASS_DAWN_2},
   ...
   { {TRAINER_PSYCHIC_PRESTON, TRAINER_PSYCHIC_PRESTON_2},
      MAP(MAP_ROUTE5) },
   ...
   { {TRAINER_PSYCHIC_LUCIAN, TRAINER_PSYCHIC_LUCIAN_2},
      MAP(MAP_ROUTE6) },
   ...
   { {TRAINER_TRENDSETTER_TYLER, TRAINER_YOUNGSTER_TYLER_2},
      MAP(MAP_SSANNE_1F_ROOM2) },

   { {TRAINER_PICNICKER_MARTHA, TRAINER_PICNICKER_MARTHA_2},
      MAP(MAP_ROCK_TUNNEL_B1F) },

   { {TRAINER_NINJA_KAYDEN, TRAINER_NINJA_KAYDEN_2},
      MAP(MAP_FUCHSIA_CITY_GYM) },
   { {TRAINER_NINJA_SHAWN, TRAINER_NINJA_SHAWN_2},
      MAP(MAP_FUCHSIA_CITY_GYM) },
   { {TRAINER_NINJA_KIRK, TRAINER_NONE},
      MAP(MAP_FUCHSIA_CITY_GYM) },
   { {TRAINER_NINJA_EDGAR, TRAINER_NINJA_EDGAR_2},
      MAP(MAP_FUCHSIA_CITY_GYM) },
   { {TRAINER_NINJA_PHIL, TRAINER_NONE},
      MAP(MAP_FUCHSIA_CITY_GYM) },
   { {TRAINER_NINJA_NATE, TRAINER_NINJA_NATE},
      MAP(MAP_FUCHSIA_CITY_GYM) },
   ...
   { {TRAINER_TRENDSETTER_DALE, TRAINER_FISHERMAN_DALE_2},
   ...
   { {TRAINER_TEAM_ROCKET_GRUNT_29, TRAINER_NONE},
      MAP(MAP_SILPH_CO_5F) },
   { {TRAINER_SCIENTIST_DALTON, TRAINER_NONE},
      MAP(MAP_SILPH_CO_5F) },
   ...
   { {TRAINER_BLACK_BELT_DAISUKE, TRAINER_BLACK_BELT_DAISUKE_2},
      MAP(MAP_VICTORY_ROAD_2F) },
   { {TRAINER_ACE_TRAINER_NELSON, TRAINER_ACE_TRAINER_NELSON_2},
      MAP(MAP_VICTORY_ROAD_2F) },
   { {TRAINER_RUIN_MANIAC_VINCENT, TRAINER_RUIN_MANIAC_VINCENT_2},
      MAP(MAP_VICTORY_ROAD_2F) },
   { {TRAINER_ACE_TRAINER_GREGORY, TRAINER_ACE_TRAINER_GREGORY_2},
      MAP(MAP_VICTORY_ROAD_2F) },
   ...
   { {TRAINER_ACE_TRAINER_CAROLINE, TRAINER_ACE_TRAINER_CAROLINE_2},
      MAP(MAP_VICTORY_ROAD_3F) },
   { {TRAINER_ACES_RAY_TYRA, TRAINER_ACES_RAY_TYRA_2},
      MAP(MAP_VICTORY_ROAD_3F) },
   ...
   { {TRAINER_BLACK_BELT_ATSUSHI, TRAINER_NONE},
      MAP(MAP_VIRIDIAN_CITY_GYM) },
   { {TRAINER_NINJA_JASON, TRAINER_NONE},
      MAP(MAP_VIRIDIAN_CITY_GYM) },
