...
static const struct RematchData sRematches[] = {
   { {TRAINER_YOUNGSTER_BEN, TRAINER_YOUNGSTER_BEN_2, SKIP, TRAINER_YOUNGSTER_BEN_3, TRAINER_YOUNGSTER_BEN_4}, MAP(MAP_ROUTE1) },
   { {TRAINER_YOUNGSTER_CALVIN, TRAINER_YOUNGSTER_CALVIN}, MAP(MAP_ROUTE2) },
   ...
   { {TRAINER_BUG_CATCHER_GREG, TRAINER_BUG_CATCHER_GREG_2},
      MAP(MAP_ROUTE3) },
   { {TRAINER_BUG_CATCHER_JAMES, TRAINER_BUG_CATCHER_JAMES_2},
      MAP(MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL) },
   { {TRAINER_LASS_JANICE, TRAINER_LASS_JANICE_2, SKIP, TRAINER_LASS_JANICE_3},
      MAP(MAP_ROUTE1) },
   { {TRAINER_LASS_SALLY, TRAINER_LASS_SALLY_2},
      MAP(MAP_ROUTE2) },
   ...
   { {TRAINER_YOUNGSTER_CHAD, TRAINER_YOUNGSTER_CHAD_2, SKIP, TRAINER_YOUNGSTER_CHAD_3, TRAINER_YOUNGSTER_CHAD_4},
      MAP(MAP_ROUTE7) },
   { {TRAINER_CAMPER_KYLE, TRAINER_CAMPER_KYLE_2, SKIP, TRAINER_CAMPER_KYLE_3, TRAINER_CAMPER_KYLE_4},
      MAP(MAP_ROUTE10) },
   ...
   { {TRAINER_CAMPER_FLINT, TRAINER_CAMPER_FLINT},
      MAP(MAP_ROUTE12) },
   { {TRAINER_BUG_CATCHER_KEIGO, TRAINER_BUG_CATCHER_KEIGO_2},
      MAP(MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL) },
   { {TRAINER_BUG_CATCHER_ELIJAH, TRAINER_BUG_CATCHER_ELIJAH_2},
      MAP(MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL) },
   ...
   { {TRAINER_PICNICKER_NANCY, TRAINER_PICNICKER_NANCY},
      MAP(MAP_ROUTE2) },
   { {TRAINER_CAMPER_ISAAC, TRAINER_CAMPER_ISAAC_2, SKIP, TRAINER_CAMPER_ISAAC_3, TRAINER_CAMPER_ISAAC_4},
      MAP(MAP_ROUTE9) },
   ...
   { {TRAINER_ENGINEER_BERNIE, SKIP, SKIP, TRAINER_ENGINEER_BERNIE_2},
      MAP(MAP_ROUTE11) },
   { {TRAINER_GAMER_HUGO, TRAINER_GAMER_HUGO_2},
      MAP(MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL) },
   { {TRAINER_GAMER_JASPER, TRAINER_GAMER_JASPER},
      MAP(MAP_ROUTE11) },
   { {TRAINER_GAMER_DIRK, TRAINER_GAMER_DIRK_2},
      MAP(MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL) },
   ...
   { {TRAINER_POKEMANIAC_HERMAN, SKIP, SKIP, TRAINER_POKEMANIAC_HERMAN_2, SKIP, TRAINER_POKEMANIAC_HERMAN_3},
      MAP(MAP_ROUTE10) },
   { {TRAINER_HIKER_CLARK, TRAINER_HIKER_CLARK_2},
      MAP(MAP_ROUTE10) },
   ...
   { {TRAINER_SUPER_NERD_GLENN, SKIP, SKIP, TRAINER_SUPER_NERD_GLENN_2},
      MAP(MAP_ROUTE8) },
   { {TRAINER_SUPER_NERD_LESLIE, TRAINER_SUPER_NERD_LESLIE_2},
      MAP(MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL) },
   ...
   { {TRAINER_TWINS_ELI_ANNE, SKIP, SKIP, TRAINER_TWINS_ELI_ANNE_2},
      MAP(MAP_ROUTE8) },
   { {TRAINER_BIKER_RICARDO, TRAINER_BIKER_RICARDO_2},
      MAP(MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL) },
   ...
   { {TRAINER_BIKER_LAO, TRAINER_BIKER_LAO},
      MAP(MAP_ROUTE16) },
   { {TRAINER_BIKER_HIDEO, TRAINER_BIKER_HIDEO_2},
      MAP(MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL) },
   ...
   { {TRAINER_GENTLEMAN_CLIFFORD, TRAINER_GENTLEMAN_CLIFFORD},
      MAP(MAP_SEVEN_ISLAND_TANOBY_RUINS) },
   { {TRAINER_CAMPER_LIAM, TRAINER_CAMPER_LIAM_2},
      MAP(MAP_ROUTE1) },
   ...
   { {TRAINER_LASS_DAWN, TRAINER_LASS_DAWN_2},
      MAP(MAP_ROUTE12) },
   { {TRAINER_YOUNGSTER_JOHNSON, TRAINER_YOUNGSTER_JOHNSON_2},
      MAP(MAP_ROUTE13) },
   { {TRAINER_YOUNGSTER_DESTIN, TRAINER_YOUNGSTER_DESTIN_2},
      MAP(MAP_ROUTE14) },
   { {TRAINER_YOUNGSTER_CORDELL, TRAINER_YOUNGSTER_CORDELL_2},
      MAP(MAP_ROUTE15) },
   ...
   { {TRAINER_LASS_LISA, TRAINER_LASS_LISA_2},
      MAP(MAP_ROUTE18) },
   { {TRAINER_CAMPER_MARCO, TRAINER_CAMPER_MARCO_2},
      MAP(MAP_ROUTE18) },
   { {TRAINER_TUBER_AMIRA, TRAINER_TUBER_AMIRA_2},
      MAP(MAP_ROUTE20) },
   { {TRAINER_TUBER_NOAH, TRAINER_TUBER_NOAH_2},
      MAP(MAP_ROUTE20) },
   { {TRAINER_TUBER_ALEXIS, TRAINER_TUBER_ALEXIS_2},
      MAP(MAP_ROUTE21_NORTH) },
   { {TRAINER_LASS_NADIA, TRAINER_LASS_NADIA_2},
      MAP(MAP_ROUTE24) },
   { {TRAINER_RUNNING_TRIATHLETE_M, TRAINER_RUNNING_TRIATHLETE_M_2},
      MAP(MAP_ROUTE25) },
   { {TRAINER_RUNNING_TRIATHLETE_F, TRAINER_RUNNING_TRIATHLETE_F_2},
      MAP(MAP_ROUTE25) },
   { {TRAINER_LASS_DALIA, TRAINER_LASS_DALIA_2},
      MAP(MAP_ROUTE25) },
   { {TRAINER_LASS_JOANA, TRAINER_LASS_JOANA_2},
      MAP(MAP_ROUTE25) },
   ...
   { {TRAINER_PSYCHIC_JOHAN, TRAINER_PSYCHIC_JOHAN_2},
      MAP(MAP_ROUTE5) },
   { {TRAINER_LASS_IRIS, TRAINER_LASS_IRIS_2},
      MAP(MAP_ROUTE6) },
   { {TRAINER_PSYCHIC_TYRON, TRAINER_PSYCHIC_TYRON_2},
      MAP(MAP_ROUTE6) },
   ...
   { {TRAINER_PICNICKER_MARTHA, TRAINER_PICNICKER_MARTHA_2},
      MAP(MAP_ROUTE8) },
   { {TRAINER_LASS_NORA, TRAINER_LASS_NORA_2},
      MAP(MAP_ROUTE9) },
};
