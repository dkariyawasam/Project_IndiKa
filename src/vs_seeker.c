...
static const struct RematchData sRematches[] = {
   ...
   { {TRAINER_TAMER_PHIL, TRAINER_TAMER_PHIL_2},
      MAP(MAP_FUCHSIA_CITY_GYM) },
   { {TRAINER_JUGGLER_NATE, TRAINER_JUGGLER_NATE_2},
      MAP(MAP_FUCHSIA_CITY_GYM) },
   ...
   { {TRAINER_CHANNELER_HOPE, TRAINER_CHANNELER_HOPE_2},
      MAP(MAP_POKEMON_TOWER_3F) },
   { {TRAINER_CHANNELER_LAUREL, TRAINER_CHANNELER_LAUREL_2},
      MAP(MAP_POKEMON_TOWER_4F) },
   { {TRAINER_CHANNELER_JODY, TRAINER_CHANNELER_JODY_2},
      MAP(MAP_POKEMON_TOWER_4F) },
   { {TRAINER_CHANNELER_PAULA, TRAINER_CHANNELER_PAULA_2},
      MAP(MAP_POKEMON_TOWER_4F) },
   { {TRAINER_CHANNELER_RUTH, TRAINER_CHANNELER_RUTH_2},
      MAP(MAP_POKEMON_TOWER_5F) },
   { {TRAINER_CHANNELER_TAMMY, TRAINER_CHANNELER_TAMMY_2},
      MAP(MAP_POKEMON_TOWER_5F) },
   { {TRAINER_CHANNELER_KARINA, TRAINER_CHANNELER_KARINA_2},
      MAP(MAP_POKEMON_TOWER_5F) },
   { {TRAINER_CHANNELER_JANAE, TRAINER_CHANNELER_JANAE_2},
      MAP(MAP_POKEMON_TOWER_5F) },
   ...
   { {TRAINER_GENTLEMAN_THOMAS, TRAINER_GENTLEMAN_THOMAS_2},
   ...
   { {TRAINER_SAILOR_LEONARD, TRAINER_SAILOR_LEONARD_2},
      MAP(MAP_SSANNE_B1F_ROOM4) },
   ...
   { {TRAINER_TEAM_ROCKET_GRUNT_37, TRAINER_TEAM_ROCKET_GRUNT_37_2},
      MAP(MAP_SILPH_CO_9F) },
   { {TRAINER_COOLTRAINER_ROLANDO, TRAINER_COOLTRAINER_ROLANDO_2},
      MAP(MAP_VICTORY_ROAD_1F) },
   { {TRAINER_COOLTRAINER_NAOMI, TRAINER_COOLTRAINER_NAOMI_2},
      MAP(MAP_VICTORY_ROAD_1F) },
   ...
   { {TRAINER_JUGGLER_GREGORY, TRAINER_JUGGLER_GREGORY_2},
      MAP(MAP_VICTORY_ROAD_2F) },
   { {TRAINER_COOLTRAINER_GEORGE, TRAINER_COOLTRAINER_GEORGE_2},
      MAP(MAP_VICTORY_ROAD_3F) },
   { {TRAINER_COOLTRAINER_ALEXA, TRAINER_COOLTRAINER_ALEXA_2},
      MAP(MAP_VICTORY_ROAD_3F) },
   { {TRAINER_COOLTRAINER_COLBY, TRAINER_COOLTRAINER_COLBY_2},
      MAP(MAP_VICTORY_ROAD_3F) },
   { {TRAINER_COOLTRAINER_CAROLINE, TRAINER_COOLTRAINER_CAROLINE_2},
      MAP(MAP_VICTORY_ROAD_3F) },
   ...
   { {TRAINER_COOLTRAINER_YUJI, TRAINER_COOLTRAINER_YUJI_2},
      MAP(MAP_VIRIDIAN_CITY_GYM) },
   { {TRAINER_BLACK_BELT_ATSUSHI, TRAINER_BLACK_BELT_ATSUSHI_2},
      MAP(MAP_VIRIDIAN_CITY_GYM) },
   { {TRAINER_TAMER_JASON, TRAINER_TAMER_JASON_2},
      MAP(MAP_VIRIDIAN_CITY_GYM) },
   { {TRAINER_TAMER_COLE, TRAINER_TAMER_COLE_2},
      MAP(MAP_VIRIDIAN_CITY_GYM) },
   { {TRAINER_BLACK_BELT_KIYO, TRAINER_BLACK_BELT_KIYO_2},
      MAP(MAP_VIRIDIAN_CITY_GYM) },
   { {TRAINER_COOLTRAINER_SAMUEL, TRAINER_COOLTRAINER_SAMUEL_2},
      MAP(MAP_VIRIDIAN_CITY_GYM) },
   { {TRAINER_COOLTRAINER_WARREN, TRAINER_COOLTRAINER_WARREN_2},
      MAP(MAP_VIRIDIAN_CITY_GYM) },
