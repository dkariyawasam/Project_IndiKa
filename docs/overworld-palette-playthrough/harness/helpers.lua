function qa.script(bytes)
 ...
 emu:write32(0x03000f0c,135530416);emu:write32(0x03000f10,135531288)
...
function qa.progress(name)
 local f=io.open('/Users/deekariyawasam/pokefirered/docs/overworld-palette-playthrough/progress.tsv','a')
