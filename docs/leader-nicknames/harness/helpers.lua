function qa.script(bytes)
 ...
 emu:write32(0x03000f0c,qa.sym.gScriptCmdTable);emu:write32(0x03000f10,qa.sym.gScriptCmdTableEnd)
...
function qa.progress(name)
 local f=io.open('/Users/deekariyawasam/pokefirered/docs/leader-nicknames/progress.tsv','a')
...
qa.travelAssist=callbacks:add('frame',function()
 ...
 if c and (c.kind=='walk' or c.kind=='map') and (emu:read8(0x03000f9c)~=0 or emu:read32(0x03003264)~=(qa.sym.CB2_Overworld+1)) then
